...
class HmipLocalServices(StrEnum):
    ...
    COVER_GET_SCHEDULE = "cover_get_schedule"
    COVER_SET_SCHEDULE = "cover_set_schedule"
    ...
    LIGHT_GET_SCHEDULE = "light_get_schedule"
    LIGHT_SET_ON_TIME = "light_set_on_time"
    LIGHT_SET_SCHEDULE = "light_set_schedule"

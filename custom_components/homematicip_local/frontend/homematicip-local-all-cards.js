 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const $=globalThis,S=e=>e,k=$.trustedTypes,E=k?k.createPolicy("lit-html",{createHTML:e=>e}):void 0,T="$lit$",A=`lit$${Math.random().toFixed(9).slice(2)}$`,D="?"+A,C=`<${D}>`,M=document,L=()=>M.createComment(""),P=e=>null===e||"object"!=typeof e&&"function"!=typeof e,I=Array.isArray,O="[ \t\n\f\r]",N=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,H=/-->/g,B=/>/g,z=RegExp(`>|${O}(?:([^\\s"'>=/]+)(${O}*=${O}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),W=/'/g,U=/"/g,R=/^(?:script|style|textarea|title)$/i,F=(e,...t)=>({_$litType$:1,strings:e,values:t}),V=Symbol.for("lit-noChange"),j=Symbol.for("lit-nothing"),Z=new WeakMap,Y=M.createTreeWalker(M,129);function q(e,t){if(!I(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==E?E.createHTML(t):t}class J{constructor({strings:e,_$litType$:t},i){let s;this.parts=[];let a=0,o=0;const n=e.length-1,r=this.parts,[l,d]=((e,t)=>{const i=e.length-1,s=[];let a,o=2===t?"<svg>":3===t?"<math>":"",n=N;for(let t=0;t<i;t++){const i=e[t];let r,l,d=-1,c=0;for(;c<i.length&&(n.lastIndex=c,l=n.exec(i),null!==l);)c=n.lastIndex,n===N?"!--"===l[1]?n=H:void 0!==l[1]?n=B:void 0!==l[2]?(R.test(l[2])&&(a=RegExp("</"+l[2],"g")),n=z):void 0!==l[3]&&(n=z):n===z?">"===l[0]?(n=a??N,d=-1):void 0===l[1]?d=-2:(d=n.lastIndex-l[2].length,r=l[1],n=void 0===l[3]?z:'"'===l[3]?U:W):n===U||n===W?n=z:n===H||n===B?n=N:(n=z,a=void 0);const h=n===z&&e[t+1].startsWith("/>")?" ":"";o+=n===N?i+C:d>=0?(s.push(r),i.slice(0,d)+T+i.slice(d)+A+h):i+A+(-2===d?t:h)}return[q(e,o+(e[i]||"<?>")+(2===t?"</svg>":3===t?"</math>":"")),s]})(e,t);if(this.el=J.createElement(l,i),Y.currentNode=this.el.content,2===t||3===t){const e=this.el.content.firstChild;e.replaceWith(...e.childNodes)}for(;null!==(s=Y.nextNode())&&r.length<n;){if(1===s.nodeType){if(s.hasAttributes())for(const e of s.getAttributeNames())if(e.endsWith(T)){const t=d[o++],i=s.getAttribute(e).split(A),n=/([.?@])?(.*)/.exec(t);r.push({type:1,index:a,name:n[2],strings:i,ctor:"."===n[1]?ee:"?"===n[1]?te:"@"===n[1]?ie:Q}),s.removeAttribute(e)}else e.startsWith(A)&&(r.push({type:6,index:a}),s.removeAttribute(e));if(R.test(s.tagName)){const e=s.textContent.split(A),t=e.length-1;if(t>0){s.textContent=k?k.emptyScript:"";for(let i=0;i<t;i++)s.append(e[i],L()),Y.nextNode(),r.push({type:2,index:++a});s.append(e[t],L())}}}else if(8===s.nodeType)if(s.data===D)r.push({type:2,index:a});else{let e=-1;for(;-1!==(e=s.data.indexOf(A,e+1));)r.push({type:7,index:a}),e+=A.length-1}a++}}static createElement(e,t){const i=M.createElement("template");return i.innerHTML=e,i}}function G(e,t,i=e,s){if(t===V)return t;let a=void 0!==s?i._$Co?.[s]:i._$Cl;const o=P(t)?void 0:t._$litDirective$;return a?.constructor!==o&&(a?._$AO?.(!1),void 0===o?a=void 0:(a=new o(e),a._$AT(e,i,s)),void 0!==s?(i._$Co??=[])[s]=a:i._$Cl=a),void 0!==a&&(t=G(e,a._$AS(e,t.values),a,s)),t}class K{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:t},parts:i}=this._$AD,s=(e?.creationScope??M).importNode(t,!0);Y.currentNode=s;let a=Y.nextNode(),o=0,n=0,r=i[0];for(;void 0!==r;){if(o===r.index){let t;2===r.type?t=new X(a,a.nextSibling,this,e):1===r.type?t=new r.ctor(a,r.name,r.strings,this,e):6===r.type&&(t=new se(a,this,e)),this._$AV.push(t),r=i[++n]}o!==r?.index&&(a=Y.nextNode(),o++)}return Y.currentNode=M,s}p(e){let t=0;for(const i of this._$AV)void 0!==i&&(void 0!==i.strings?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}}class X{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,i,s){this.type=2,this._$AH=j,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=s,this._$Cv=s?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return void 0!==t&&11===e?.nodeType&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=G(this,e,t),P(e)?e===j||null==e||""===e?(this._$AH!==j&&this._$AR(),this._$AH=j):e!==this._$AH&&e!==V&&this._(e):void 0!==e._$litType$?this.$(e):void 0!==e.nodeType?this.T(e):(e=>I(e)||"function"==typeof e?.[Symbol.iterator])(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==j&&P(this._$AH)?this._$AA.nextSibling.data=e:this.T(M.createTextNode(e)),this._$AH=e}$(e){const{values:t,_$litType$:i}=e,s="number"==typeof i?this._$AC(e):(void 0===i.el&&(i.el=J.createElement(q(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===s)this._$AH.p(t);else{const e=new K(s,this),i=e.u(this.options);e.p(t),this.T(i),this._$AH=e}}_$AC(e){let t=Z.get(e.strings);return void 0===t&&Z.set(e.strings,t=new J(e)),t}k(e){I(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let i,s=0;for(const a of e)s===t.length?t.push(i=new X(this.O(L()),this.O(L()),this,this.options)):i=t[s],i._$AI(a),s++;s<t.length&&(this._$AR(i&&i._$AB.nextSibling,s),t.length=s)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){const t=S(e).nextSibling;S(e).remove(),e=t}}setConnected(e){void 0===this._$AM&&(this._$Cv=e,this._$AP?.(e))}}class Q{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,i,s,a){this.type=1,this._$AH=j,this._$AN=void 0,this.element=e,this.name=t,this._$AM=s,this.options=a,i.length>2||""!==i[0]||""!==i[1]?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=j}_$AI(e,t=this,i,s){const a=this.strings;let o=!1;if(void 0===a)e=G(this,e,t,0),o=!P(e)||e!==this._$AH&&e!==V,o&&(this._$AH=e);else{const s=e;let n,r;for(e=a[0],n=0;n<a.length-1;n++)r=G(this,s[i+n],t,n),r===V&&(r=this._$AH[n]),o||=!P(r)||r!==this._$AH[n],r===j?e=j:e!==j&&(e+=(r??"")+a[n+1]),this._$AH[n]=r}o&&!s&&this.j(e)}j(e){e===j?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class ee extends Q{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===j?void 0:e}}class te extends Q{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==j)}}class ie extends Q{constructor(e,t,i,s,a){super(e,t,i,s,a),this.type=5}_$AI(e,t=this){if((e=G(this,e,t,0)??j)===V)return;const i=this._$AH,s=e===j&&i!==j||e.capture!==i.capture||e.once!==i.once||e.passive!==i.passive,a=e!==j&&(i===j||s);s&&this.element.removeEventListener(this.name,this,i),a&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){"function"==typeof this._$AH?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}}class se{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){G(this,e)}}const ae={I:X},oe=$.litHtmlPolyfillSupport;oe?.(J,X),($.litHtmlVersions??=[]).push("3.3.2");const ne=globalThis;
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */function pe(e){return he({...e,state:!0,attribute:!1})}const ue=["MONDAY","TUESDAY","WEDNESDAY","THURSDAY","FRIDAY","SATURDAY","SUNDAY"],me=["fixed_time","astro","fixed_if_before_astro","astro_if_before_fixed","fixed_if_after_astro","astro_if_after_fixed","earliest","latest"],_e={switch:{levelType:"binary",hasLevel2:!1,hasDuration:!0,hasRampTime:!1},light:{levelType:"percentage",hasLevel2:!1,hasDuration:!0,hasRampTime:!0},cover:{levelType:"percentage",hasLevel2:!0,hasDuration:!1,hasRampTime:!1},valve:{levelType:"percentage",hasLevel2:!1,hasDuration:!0,hasRampTime:!1}},ge=["ms","s","min","h"];function ve(e){const[t,i]=e.split(":").map(Number);return 60*t+i}function fe(e){const t=e%60;return`${Math.floor(e/60).toString().padStart(2,"0")}:${t.toString().padStart(2,"0")}`}function ye(e,t="24"){if("24"===t)return e;const[i,s]=e.split(":");let a=parseInt(i,10);if(24===a)return"12:00 AM";const o=a>=12?"PM":"AM";return 0===a?a=12:a>12&&(a-=12),`${a}:${s||"00"} ${o}`}function be(e){return e<10?"#2b9af9":e<14?"#40c4ff":e<17?"#26c6da":e<19?"#66bb6a":e<21?"#9ccc65":e<23?"#ffb74d":e<25?"#ff8100":"#f4511e"}function xe(e){if(!e)return;const t=e.split(":");return 2===t.length?t[0]:void 0}function we(e){const{base_temperature:t,periods:i}=e,s=[],a=[...i].sort((e,t)=>ve(e.starttime)-ve(t.starttime));for(let e=0;e<a.length;e++){const t=a[e];s.push({startTime:t.starttime,startMinutes:ve(t.starttime),endTime:t.endtime,endMinutes:ve(t.endtime),temperature:t.temperature,slot:e+1})}return{blocks:s,baseTemperature:t}}function $e(e,t){const i=[],s=[...e].sort((e,t)=>e.startMinutes-t.startMinutes);for(const e of s)i.push({starttime:e.startTime,endtime:e.endTime,temperature:e.temperature});return{base_temperature:t,periods:i}}function Se(e){if(0===e.length)return 20;const t=new Map;for(const i of e){const e=i.endMinutes-i.startMinutes,s=t.get(i.temperature)||0;t.set(i.temperature,s+e)}let i=0,s=20;for(const[e,a]of t.entries())a>i&&(i=a,s=e);return s}function ke(e){if(0===e.length)return[];const t=[...e].sort((e,t)=>e.startMinutes-t.startMinutes),i=[];let s={...t[0]};for(let e=1;e<t.length;e++){const a=t[e];s.endMinutes===a.startMinutes&&s.temperature===a.temperature?s={...s,endTime:a.endTime,endMinutes:a.endMinutes}:(i.push(s),s={...a})}return i.push(s),i.map((e,t)=>({...e,slot:t+1}))}function Ee(e,t){if(0===e.length)return[{startTime:"00:00",startMinutes:0,endTime:"24:00",endMinutes:1440,temperature:t,slot:1}];const i=[...e].sort((e,t)=>e.startMinutes-t.startMinutes),s=[];let a=0;for(const e of i)e.startMinutes>a&&s.push({startTime:fe(a),startMinutes:a,endTime:e.startTime,endMinutes:e.startMinutes,temperature:t,slot:s.length+1}),s.push({...e,slot:s.length+1}),a=e.endMinutes;return a<1440&&s.push({startTime:fe(a),startMinutes:a,endTime:"24:00",endMinutes:1440,temperature:t,slot:s.length+1}),ke(s)}function Te(e){return[...e].sort((e,t)=>e.startMinutes-t.startMinutes).map((e,t)=>({...e,slot:t+1}))}function Ae(e){return Boolean(Array.isArray(e.weekdays)&&e.weekdays.length>0&&Array.isArray(e.target_channels)&&e.target_channels.length>0)}function De(e){return"fixed_time"!==e}const Ce=/^(\d+(?:\.\d+)?)\s*(ms|s|min|h)$/;function Me(e){const t=e.trim().match(Ce);return t?{value:parseFloat(t[1]),unit:t[2]}:null}function Le(e,t){return`${e}${t}`}function Pe(e){return Ce.test(e.trim())}function Ie(e){const t={weekdays:e.weekdays,time:e.time,target_channels:e.target_channels,level:e.level};return"fixed_time"!==e.condition&&(t.condition=e.condition),null!==e.astro_type&&(t.astro_type=e.astro_type),0!==e.astro_offset_minutes&&(t.astro_offset_minutes=e.astro_offset_minutes),null!==e.level_2&&(t.level_2=e.level_2),null!==e.duration&&(t.duration=e.duration),null!==e.ramp_time&&(t.ramp_time=e.ramp_time),t}function Oe(e){const t={};for(const[i,s]of Object.entries(e))t[i]=Ie(s);return t}function Ne(e){return"default"===e.schedule_type}function He(e,t=5,i=30.5){const{base_temperature:s,periods:a}=e;if(s<t||s>i)return{key:"temperatureOutOfRange",params:{block:"base",min:`${t}`,max:`${i}`}};let o=0;for(let e=0;e<a.length;e++){const s=a[e];if(!s.starttime||!s.endtime||void 0===s.temperature)return{key:"slotMissingValues",params:{slot:`${e+1}`}};const n=ve(s.starttime),r=ve(s.endtime);if(r<=n)return{key:"blockEndBeforeStart",params:{block:`${e+1}`}};if(n<o)return{key:"slotTimeBackwards",params:{slot:`${e+1}`,time:s.starttime}};if(s.temperature<t||s.temperature>i)return{key:"temperatureOutOfRange",params:{block:`${e+1}`,min:`${t}`,max:`${i}`}};o=r}return null}const Be=(e,t,i)=>{const s=new CustomEvent(t,{bubbles:!0,composed:!0,detail:i});e.dispatchEvent(s)};let ze=class e extends re{constructor(){super(...arguments),this._computeLabel=e=>({entities:"Entities",name:"Card Name (optional)",editable:"Allow editing",schedule_domain:"Schedule Domain",hour_format:"Time format"}[e.name]||e.name)}_getScheduleEntityIds(){return this.hass?.states?Object.keys(this.hass.states).filter(e=>{if(!e.startsWith("sensor."))return!1;const t=this.hass?.states?.[e];return!!t&&Ne(t.attributes)}):[]}_buildEntitySchema(){return[{name:"entities",required:!0,selector:{entity:{multiple:!0,include_entities:this._getScheduleEntityIds()}}}]}static{this.OPTIONS_SCHEMA=[{name:"name",selector:{text:{}}},{name:"editable",selector:{boolean:{}},default:!0},{name:"schedule_domain",selector:{select:{options:[{value:"",label:"Auto (from entity)"},{value:"switch",label:"Switch"},{value:"light",label:"Light"},{value:"cover",label:"Cover"},{value:"valve",label:"Valve"}],mode:"dropdown"}},default:""},{name:"hour_format",selector:{select:{options:[{value:"24",label:"24h"},{value:"12",label:"12h (AM/PM)"}]}},default:"24"}]}setConfig(e){this._config=e}_getEntityIds(){return this._config?this._config.entities?this._config.entities:this._config.entity?[this._config.entity]:[]:[]}render(){if(!this.hass||!this._config)return j;const t={entities:this._getEntityIds()};return F`
      ...
      ></ha-form>
    `}_entitiesChanged(e){e.stopPropagation();const t=e.detail.value?.entities||[],i={...this._config,entities:t};delete i.entity,Be(this,"config-changed",{config:i})}_optionsChanged(e){e.stopPropagation();const t=e.detail.value,i=t.schedule_domain,s={...this._config,...t,entities:this._config.entities};i||delete s.schedule_domain,Be(this,"config-changed",{config:s})}static{this.styles=n`
    ha-form {
      display: block;
    }
  `}};function We(e){return t=>(customElements.get(e)||customElements.define(e,t),t)}
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;var ot=function(e,t,i,s){var a,o=arguments.length,n=o<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(e,t,i,s);else for(var r=e.length-1;r>=0;r--)(a=e[r])&&(n=(o<3?a(n):o>3?a(t,i,n):a(t,i))||n);return o>3&&n&&Object.defineProperty(t,i,n),n};let nt=class extends re{constructor(){super(...arguments),this.editable=!0,this._swipeX=0,this._touchStartX=0,this._touchStartY=0,this._isSwiping=!1,this._isScrolling=!1}static{this.styles=at}_onTouchStart(e,t){if(!this.editable)return;const i=e.touches[0];this._touchStartX=i.clientX,this._touchStartY=i.clientY,this._isSwiping=!1,this._isScrolling=!1,this._swipingGroupNo=t,this._swipeX=0}_onTouchMove(e){if(!this._swipingGroupNo)return;const t=e.touches[0],i=t.clientX-this._touchStartX,s=t.clientY-this._touchStartY;if(!this._isSwiping&&!this._isScrolling){if(Math.abs(s)>10)return this._isScrolling=!0,this._swipingGroupNo=void 0,void(this._swipeX=0);Math.abs(i)>10&&(this._isSwiping=!0)}this._isScrolling||this._isSwiping&&(e.preventDefault(),this._swipeX=Math.min(0,i))}_onTouchEnd(e){this._swipingGroupNo&&this._isSwiping?Math.abs(this._swipeX)>=120?(this.dispatchEvent(new CustomEvent("delete-event",{bubbles:!0,composed:!0,detail:{entry:e}})),this._resetSwipe()):(this._swipeX=0,setTimeout(()=>this._resetSwipe(),200)):this._resetSwipe()}_resetSwipe(){this._swipingGroupNo=void 0,this._swipeX=0,this._isSwiping=!1,this._isScrolling=!1}_handleAdd(){this.dispatchEvent(new CustomEvent("add-event",{bubbles:!0,composed:!0}))}_handleEdit(e){this.dispatchEvent(new CustomEvent("edit-event",{bubbles:!0,composed:!0,detail:{entry:e}}))}_handleDelete(e){this.dispatchEvent(new CustomEvent("delete-event",{bubbles:!0,composed:!0,detail:{entry:e}}))}_getConditionDisplay(e){return function(e,t,i){const s=function(e,t,i){const s="sunset"===e?i.sunset:i.sunrise;return 0===t?s:`${s} ${t>0?"+":""}${t}min`}(e.astro_type,e.astro_offset_minutes,i),a=e.time;switch(e.condition){case"fixed_time":default:return{label:t,details:a};case"astro":return{label:t,details:s};case"earliest":case"latest":case"astro_if_before_fixed":case"astro_if_after_fixed":return{label:t,details:`${s} / ${a}`};case"fixed_if_before_astro":case"fixed_if_after_astro":return{label:t,details:`${a} / ${s}`}}}(e,this.translations.conditionLabels[e.condition]||e.condition,this.translations.conditionSummaryLabels)}render(){if(!this.scheduleData)return F`<div class="no-data">${this.translations.loading}</div>`;const e=function(e){const t=[];for(const[i,s]of Object.entries(e))t.push({...s,groupNo:i,isActive:Ae(s)});return t.sort((e,t)=>e.time.localeCompare(t.time)),t}(this.scheduleData);return 0===e.length?F`
    ...
    `}};ot([he({attribute:!1})],nt.prototype,"scheduleData",void 0),ot([he({attribute:!1})],nt.prototype,"domain",void 0),ot([he({type:Boolean})],nt.prototype,"editable",void 0),ot([he({attribute:!1})],nt.prototype,"translations",void 0),ot([pe()],nt.prototype,"_swipingGroupNo",void 0),ot([pe()],nt.prototype,"_swipeX",void 0),nt=ot([We("hmip-device-schedule-list")],nt);const rt=n`
  :host {
    display: block;
  }
...
`;var lt=function(e,t,i,s){var a,o=arguments.length,n=o<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(e,t,i,s);else for(var r=e.length-1;r>=0;r--)(a=e[r])&&(n=(o<3?a(n):o>3?a(t,i,n):a(t,i))||n);return o>3&&n&&Object.defineProperty(t,i,n),n};let dt=class extends re{constructor(){super(...arguments),this.open=!1,this.isNewEvent=!1,this._validationErrors=[]}static{this.styles=rt}willUpdate(e){(e.has("open")||e.has("entry"))&&(this.open&&this.entry?(this._editingEntry={...this.entry},this._validationErrors=[]):this.open||(this._editingEntry=void 0,this._validationErrors=[]))}updated(e){super.updated(e),e.has("open")&&this.open&&!e.get("open")&&this.updateComplete.then(()=>{const e=this.shadowRoot?.querySelector("input[type='time'], ha-select, input");e?.focus()})}_updateEditingEntry(e){this._editingEntry&&(this._editingEntry={...this._editingEntry,...e},this._validationErrors=[],this.requestUpdate())}_handleClose(){this.dispatchEvent(new CustomEvent("editor-closed",{bubbles:!0,composed:!0}))}_handleSave(){if(!this._editingEntry||void 0===this.groupNo)return;const e=function(e,t){const i=[];(function(e){try{return function(e){const t=e.split(":");if(2!==t.length)throw new Error(`Invalid time format: ${e}`);const i=parseInt(t[0],10),s=parseInt(t[1],10);if(isNaN(i)||isNaN(s)||i<0||i>23||s<0||s>59)throw new Error(`Invalid time values: ${e}`)}(e),!0}catch{return!1}})(e.time)||i.push({field:"time",message:"Time must be in HH:MM format (00:00-23:59)"}),e.weekdays&&0!==e.weekdays.length||i.push({field:"weekdays",message:"At least one weekday must be selected"});const s=t?_e[t]:void 0;return"binary"===s?.levelType?0!==e.level&&1!==e.level&&i.push({field:"level",message:"Level must be 0 or 1 for switch"}):(e.level<0||e.level>1)&&i.push({field:"level",message:"Level must be between 0.0 and 1.0"}),"cover"===t&&null!==e.level_2&&(e.level_2<0||e.level_2>1)&&i.push({field:"level_2",message:"Slat position must be between 0.0 and 1.0"}),De(e.condition)&&(e.astro_offset_minutes<-720||e.astro_offset_minutes>720)&&i.push({field:"astro_offset_minutes",message:"Astro offset must be between -720 and 720 minutes"}),null===e.duration||Pe(e.duration)||i.push({field:"duration",message:"Invalid duration format"}),null===e.ramp_time||Pe(e.ramp_time)||i.push({field:"ramp_time",message:"Invalid ramp time format"}),i}(this._editingEntry,this.domain);e.length>0?this._validationErrors=e.map(e=>`${e.field}: ${e.message}`):this.dispatchEvent(new CustomEvent("save-event",{bubbles:!0,composed:!0,detail:{entry:{...this._editingEntry},groupNo:this.groupNo}}))}render(){return this.open&&this._editingEntry?F`
      ...
      <div class="form-group">
        ...
        <div class="duration-row">
          <input
            ...
            min="0"
            .value=${String(i)}
            @input=${e=>{const t=parseFloat(e.target.value);!isNaN(t)&&t>0?this._updateEditingEntry({duration:Le(t,s)}):this._updateEditingEntry({duration:null})}}
          />
          <ha-select
            .value=${s}
            .options=${ge.map(e=>({value:e,label:e}))}
            @selected=${e=>{e.stopPropagation();const t=e.detail.value;i>0&&this._updateEditingEntry({duration:Le(i,t)})}}
            @closed=${e=>e.stopPropagation()}
          ></ha-select>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="duration-row">
          <input
            ...
            min="0"
            .value=${String(i)}
            @input=${e=>{const t=parseFloat(e.target.value);!isNaN(t)&&t>0?this._updateEditingEntry({ramp_time:Le(t,s)}):this._updateEditingEntry({ramp_time:null})}}
          />
          <ha-select
            .value=${s}
            .options=${ge.map(e=>({value:e,label:e}))}
            @selected=${e=>{e.stopPropagation();const t=e.detail.value;i>0&&this._updateEditingEntry({ramp_time:Le(i,t)})}}
            @closed=${e=>e.stopPropagation()}
          ></ha-select>
        </div>
      </div>
  ...
  `}}e([he({attribute:!1})],bt.prototype,"hass",void 0),e([pe()],bt.prototype,"_config",void 0),e([pe()],bt.prototype,"_expandedEntity",void 0),customElements.get("homematicip-local-climate-schedule-card-editor")||customElements.define("homematicip-local-climate-schedule-card-editor",bt);const xt={en:{weekdays:{short:{monday:"Mo",tuesday:"Tu",wednesday:"We",thursday:"Th",friday:"Fr",saturday:"Sa",sunday:"Su"},long:{monday:"Monday",tuesday:"Tuesday",wednesday:"Wednesday",thursday:"Thursday",friday:"Friday",saturday:"Saturday",sunday:"Sunday"}},ui:{schedule:"Schedule",loading:"Loading schedule data...",entityNotFound:"Entity {entity} not found",clickToEdit:"Click on a time slot to edit the schedule",edit:"Edit {weekday}",cancel:"Cancel",save:"Save",addTimeBlock:"+ Add Time Block",copySchedule:"Copy schedule",pasteSchedule:"Paste schedule",undo:"Undo",redo:"Redo",undoShortcut:"Undo (Ctrl+Z)",redoShortcut:"Redo (Ctrl+Y)",exportSchedule:"Export",importSchedule:"Import",exportTooltip:"Export schedule to JSON file",importTooltip:"Import schedule from JSON file",exportSuccess:"Schedule exported successfully",importSuccess:"Schedule imported successfully",unsavedChanges:"Unsaved changes",saveAll:"Save all",discard:"Discard",confirmDiscardChanges:"You have unsaved changes. Do you want to discard them?",close:"Close",from:"From",to:"To",baseTemperature:"Base Temperature",baseTemperatureDescription:"Temperature for unscheduled periods",temperaturePeriods:"Temperature Periods",editSlot:"Edit",saveSlot:"Save",cancelSlotEdit:"Cancel",removeSlot:"Remove",sensorNotSupported:"Sensor entity {entity} does not have a climate schedule type.",noScheduleData:"Entity {entity} does not provide schedule data."},errors:{failedToChangeProfile:"Failed to change profile: {error}",failedToSaveSchedule:"Failed to save schedule: {error}",failedToPasteSchedule:"Failed to paste schedule: {error}",invalidSchedule:"Invalid schedule: {error}",failedToExport:"Failed to export schedule: {error}",failedToImport:"Failed to import schedule: {error}",invalidImportFile:"Invalid file format. Please select a JSON file.",invalidImportFormat:"Invalid JSON format in file.",invalidImportData:"Invalid schedule data: {error}",insufficientPermissions:"You don't have permission to perform this action."},warnings:{title:"Validation Warnings",noWarnings:"No issues detected"},validationMessages:{blockEndBeforeStart:"Block {block}: End time is before start time",blockZeroDuration:"Block {block}: Block has zero duration",invalidStartTime:"Block {block}: Invalid start time",invalidEndTime:"Block {block}: Invalid end time",temperatureOutOfRange:"Block {block}: Temperature out of range ({min}-{max}°C)",invalidSlotCount:"Invalid number of slots: {count} (expected 13)",invalidSlotKey:"Invalid slot key: {key} (must be integer 1-13)",missingSlot:"Missing slot {slot}",slotMissingValues:"Slot {slot} missing ENDTIME or TEMPERATURE",slotTimeBackwards:"Slot {slot} time goes backwards: {time}",slotTimeExceedsDay:"Slot {slot} time exceeds 24:00: {time}",lastSlotMustEnd:"Last slot must end at 24:00",scheduleMustBeObject:"Schedule data must be an object",missingWeekday:"Missing weekday: {weekday}",invalidWeekdayData:"Invalid data for {weekday}",weekdayValidationError:"{weekday}: {details}"}},de:{weekdays:{short:{monday:"Mo",tuesday:"Di",wednesday:"Mi",thursday:"Do",friday:"Fr",saturday:"Sa",sunday:"So"},long:{monday:"Montag",tuesday:"Dienstag",wednesday:"Mittwoch",thursday:"Donnerstag",friday:"Freitag",saturday:"Samstag",sunday:"Sonntag"}},ui:{schedule:"Zeitplan",loading:"Zeitplandaten werden geladen...",entityNotFound:"Entität {entity} nicht gefunden",clickToEdit:"Klicken Sie auf einen Zeitabschnitt, um den Zeitplan zu bearbeiten",edit:"{weekday} bearbeiten",cancel:"Abbrechen",save:"Speichern",addTimeBlock:"+ Zeitblock hinzufügen",copySchedule:"Zeitplan kopieren",pasteSchedule:"Zeitplan einfügen",undo:"Rückgängig",redo:"Wiederholen",undoShortcut:"Rückgängig (Strg+Z)",redoShortcut:"Wiederholen (Strg+Y)",exportSchedule:"Exportieren",importSchedule:"Importieren",exportTooltip:"Zeitplan als JSON-Datei exportieren",importTooltip:"Zeitplan aus JSON-Datei importieren",exportSuccess:"Zeitplan erfolgreich exportiert",importSuccess:"Zeitplan erfolgreich importiert",unsavedChanges:"Ungespeicherte Änderungen",saveAll:"Alle speichern",discard:"Verwerfen",confirmDiscardChanges:"Sie haben ungespeicherte Änderungen. Möchten Sie diese verwerfen?",close:"Schließen",from:"Von",to:"Bis",baseTemperature:"Basistemperatur",baseTemperatureDescription:"Temperatur für nicht geplante Zeiträume",temperaturePeriods:"Temperaturperioden",editSlot:"Bearbeiten",saveSlot:"Speichern",cancelSlotEdit:"Abbrechen",removeSlot:"Entfernen",sensorNotSupported:"Sensor-Entität {entity} hat keinen Klima-Zeitplantyp.",noScheduleData:"Entität {entity} stellt keine Zeitplandaten bereit."},errors:{failedToChangeProfile:"Fehler beim Wechseln des Profils: {error}",failedToSaveSchedule:"Fehler beim Speichern des Zeitplans: {error}",failedToPasteSchedule:"Fehler beim Einfügen des Zeitplans: {error}",invalidSchedule:"Ungültiger Zeitplan: {error}",failedToExport:"Fehler beim Exportieren des Zeitplans: {error}",failedToImport:"Fehler beim Importieren des Zeitplans: {error}",invalidImportFile:"Ungültiges Dateiformat. Bitte wählen Sie eine JSON-Datei.",invalidImportFormat:"Ungültiges JSON-Format in der Datei.",invalidImportData:"Ungültige Zeitplandaten: {error}",insufficientPermissions:"Sie haben keine Berechtigung für diese Aktion."},warnings:{title:"Validierungswarnungen",noWarnings:"Keine Probleme erkannt"},validationMessages:{blockEndBeforeStart:"Block {block}: Die Endzeit liegt vor der Startzeit",blockZeroDuration:"Block {block}: Der Block hat keine Dauer",invalidStartTime:"Block {block}: Ungültige Startzeit",invalidEndTime:"Block {block}: Ungültige Endzeit",temperatureOutOfRange:"Block {block}: Temperatur außerhalb des Bereichs ({min}-{max}°C)",invalidSlotCount:"Ungültige Anzahl an Slots: {count} (erwartet 13)",invalidSlotKey:"Ungültiger Slot-Schlüssel: {key} (muss eine Ganzzahl 1-13 sein)",missingSlot:"Slot {slot} fehlt",slotMissingValues:"Slot {slot} fehlt ENDTIME oder TEMPERATURE",slotTimeBackwards:"Slot {slot}: Zeit läuft rückwärts: {time}",slotTimeExceedsDay:"Slot {slot}: Zeit überschreitet 24:00: {time}",lastSlotMustEnd:"Der letzte Slot muss um 24:00 enden",scheduleMustBeObject:"Zeitplandaten müssen ein Objekt sein",missingWeekday:"Fehlender Wochentag: {weekday}",invalidWeekdayData:"Ungültige Daten für {weekday}",weekdayValidationError:"{weekday}: {details}"}}};function wt(e){const t=e.toLowerCase().split("-")[0];return xt[t]||xt.en}function $t(e,t){let i=e;for(const[e,s]of Object.entries(t))i=i.replace(`{${e}}`,s);return i}class St extends re{constructor(){super(...arguments),this._availableProfiles=[],this._userSelectedProfile=!1,this._isLoading=!1,this._translations=wt("en"),this._minTemp=5,this._maxTemp=30.5,this._tempStep=.5,this._alertType="error"}static getConfigElement(){return document.createElement("homematicip-local-climate-schedule-card-editor")}static getStubConfig(e){const t=Object.keys(e.states).filter(t=>t.startsWith("climate.")&&void 0!==e.states[t].attributes?.schedule_data);return{type:"custom:homematicip-local-climate-schedule-card",entities:t.length>0?[t[0]]:[]}}_showAlert(e,t="error"){this._alertMessage=e,this._alertType=t}_dismissAlert(){this._alertMessage=void 0}get _isEditable(){return this._config?.editable??!0}setConfig(e){const t=[],i=e=>{if(!e)return;const i=e.trim();i&&(t.includes(i)||t.push(i))};if(i(e.entity),Array.isArray(e.entities)&&e.entities.forEach(e=>{const t="string"==typeof e?e:e.entity;i(t)}),0===t.length)return this._config={show_profile_selector:!0,editable:!0,show_temperature:!0,show_gradient:!1,hour_format:"24",...e,entities:[]},this._activeEntityId=void 0,void(this._scheduleData=void 0);t.sort((e,t)=>e.localeCompare(t));const s=this._activeEntityId,a=t[0],o=s&&t.includes(s)?s:a;this._config={show_profile_selector:!0,editable:!0,show_temperature:!0,temperature_unit:"°C",hour_format:"24",...e,entity:a},this._activeEntityId=o,this._copiedSchedule=void 0,this._editingWeekday=void 0,this._updateLanguage()}_getPreferredLanguage(e){return e?.language||e?.locale?.language}_updateLanguage(){let e="en";if(this._config?.language)e=this._config.language;else{const t=this._getPreferredLanguage(this.hass);t&&(e=t)}this._translations=wt(e),this._weekdayShortLabelMap=this._createWeekdayLabelMap("short"),this._weekdayLongLabelMap=this._createWeekdayLabelMap("long")}_createWeekdayLabelMap(e){const t="short"===e?this._translations.weekdays.short:this._translations.weekdays.long;return{MONDAY:t.monday,TUESDAY:t.tuesday,WEDNESDAY:t.wednesday,THURSDAY:t.thursday,FRIDAY:t.friday,SATURDAY:t.saturday,SUNDAY:t.sunday}}_getWeekdayLabel(e,t="short"){return"long"===t?(this._weekdayLongLabelMap||(this._weekdayLongLabelMap=this._createWeekdayLabelMap("long")),this._weekdayLongLabelMap[e]):(this._weekdayShortLabelMap||(this._weekdayShortLabelMap=this._createWeekdayLabelMap("short")),this._weekdayShortLabelMap[e])}_getEntityId(e){return"string"==typeof e?e:e.entity}_getEntityOptions(){return this._config?this._config.entities?.length?this._config.entities.map(e=>this._getEntityId(e)).sort((e,t)=>e.localeCompare(t)):this._config.entity?[this._config.entity]:[]:[]}_getEntityDisplayName(e){if(this._config?.entities?.length){const t=this._config.entities.find(t=>this._getEntityId(t)===e);if(t&&"string"!=typeof t&&t.name)return t.name}return this.hass?.states?.[e]?.attributes.friendly_name||e}_getProfileDisplayName(e){const t=this._getActiveEntityId();if(t&&this._config?.entities?.length){const i=this._config.entities.find(e=>this._getEntityId(e)===t);if(i&&"string"!=typeof i&&i.profile_names?.[e])return`${e} - ${i.profile_names[e]}`}return e}_getActiveEntityId(){const e=this._getEntityOptions();if(0!==e.length)return this._activeEntityId&&e.includes(this._activeEntityId)?this._activeEntityId:e[0]}_needsManualReload(e){if(!e||!this.hass)return!1;const t=this.hass.states[e];if(!t?.attributes?.interface_id)return!1;const i=t.attributes.interface_id;return i.endsWith("BidCos-RF")||i.endsWith("BidCos-Wired")||i.endsWith("VirtualDevices")}_getDeviceAddress(e){const t=this.hass?.states[e];return xe(t?.attributes?.address)}_requireDeviceAddress(e){const t=this._getDeviceAddress(e);if(!t)throw new Error(`Cannot resolve device_address for entity ${e}. Ensure the entity has a valid address attribute (format: "device_address:channel").`);return t}_requireConfigEntryId(e){const t=this.hass?.states[e],i=t?.attributes?.config_entry_id;if(!i)throw new Error(`Cannot resolve config_entry_id for entity ${e}. Ensure the entity has a valid config_entry_id attribute.`);return i}async _callSetActiveProfile(e,t){const i=this._requireConfigEntryId(e),s=this._requireDeviceAddress(e);await async function(e,t,i,s){return e.callWS({type:"homematicip_local/config/set_climate_active_profile",entry_id:t,device_address:i,profile:s})}(this.hass,i,s,t)}async _callSetScheduleWeekday(e,t,i,s,a){const o=this._requireConfigEntryId(e),n=this._requireDeviceAddress(e);await async function(e,t,i,s,a,o,n){return e.callWS({type:"homematicip_local/config/set_climate_schedule_weekday",entry_id:t,device_address:i,profile:s,weekday:a,base_temperature:o,simple_weekday_list:n})}(this.hass,o,n,t,i,s,a)}_scheduleReloadDeviceConfig(e){if(!this.hass)return;const t=this._getDeviceAddress(e);if(!t)return;const i=this.hass.states[e],s=i?.attributes?.config_entry_id;s&&setTimeout(async()=>{try{await ct(this.hass,s,t)}catch{}},5e3)}_formatValidationParams(e){if(!e)return{};const t={};for(const[i,s]of Object.entries(e))"weekday"===i&&ue.includes(s)?t.weekday=this._getWeekdayLabel(s,"long"):t[i]=s;return t}_translateValidationMessage(e){const t=this._translations.validationMessages[e.key]||e.key,i=this._formatValidationParams(e.params);return e.nested&&(i.details=this._translateValidationMessage(e.nested)),$t(t,i)}getCardSize(){return 12}willUpdate(e){if(super.willUpdate(e),e.has("hass")&&this._config){this._updateFromEntity();const t=e.get("hass");this._getPreferredLanguage(this.hass)!==this._getPreferredLanguage(t)&&this._updateLanguage()}}connectedCallback(){super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback(),void 0!==this._loadingTimeoutId&&(clearTimeout(this._loadingTimeoutId),this._loadingTimeoutId=void 0)}_updateFromEntity(){if(!this.hass||!this._config)return;const e=this._getActiveEntityId();if(!e)return this._currentProfile=void 0,this._activeDeviceProfile=void 0,this._scheduleData=void 0,void(this._availableProfiles=[]);const t=this.hass.states?.[e];if(!t)return this._currentProfile=void 0,this._activeDeviceProfile=void 0,this._scheduleData=void 0,void(this._availableProfiles=[]);const i=t.attributes;if(e.startsWith("sensor.")&&"climate"!==i.schedule_type)return this._currentProfile=void 0,this._activeDeviceProfile=void 0,this._scheduleData=void 0,void(this._availableProfiles=[]);if(!i.schedule_data)return this._currentProfile=void 0,this._activeDeviceProfile=void 0,this._scheduleData=void 0,void(this._availableProfiles=[]);const s=function(e){if(null!=e)return`P${e}`}(i.device_active_profile_index);void 0!==s&&void 0!==this._activeDeviceProfile&&s!==this._activeDeviceProfile&&(this._userSelectedProfile=!1,this._reloadScheduleData(e,s)),this._activeDeviceProfile=s;const a=i.current_schedule_profile||i.active_profile;this._userSelectedProfile||(this._currentProfile=this._config.profile||s||a),this._scheduleData=i.schedule_data,this._availableProfiles=(i.available_profiles||[]).slice().sort((e,t)=>e.localeCompare(t)),this._minTemp=i.min_temp??5,this._maxTemp=i.max_temp??30.5,this._tempStep=i.target_temp_step??.5,this._lastScheduleDataHash=i.schedule_data?JSON.stringify(i.schedule_data):void 0}_reloadScheduleData(e,t){this.hass&&this._callSetActiveProfile(e,t).catch(()=>{})}async _handleProfileChange(e){e.stopPropagation();const t=e.detail.value,i=this._getActiveEntityId();if(this._config&&this.hass&&i){if(this._editingWeekday){if(!confirm(this._translations.ui.confirmDiscardChanges))return;this._editingWeekday=void 0}this._userSelectedProfile=!0;try{await this._callSetActiveProfile(i,t),this._currentProfile=t}catch(e){console.error("Failed to load profile data:",e);const t=String(e);t.includes("unauthorized")||t.includes("Unauthorized")?this._showAlert(this._translations.errors.insufficientPermissions):this._showAlert($t(this._translations.errors.failedToChangeProfile,{error:t}))}}}_onWeekdayClick(e){this._isEditable&&this._scheduleData&&(this._editingWeekday=e.detail.weekday)}_onCopySchedule(e){const t=e.detail.weekday;if(!this._scheduleData)return;const i=this._getParsedBlocks(t);let s;const a=this._scheduleData[t];s=a?we(a).baseTemperature:Se(i),this._copiedSchedule={weekday:t,blocks:JSON.parse(JSON.stringify(i)),baseTemperature:s},console.info(`Copied schedule from ${t}`)}async _onPasteSchedule(e){if(!this._isEditable)return;const t=e.detail.weekday;if(!(this._config&&this.hass&&this._currentProfile&&this._copiedSchedule))return;const i=this._getActiveEntityId();if(!i)return;const s=this._copiedSchedule.baseTemperature??Se(this._copiedSchedule.blocks),a=$e(this._copiedSchedule.blocks,s),o=He(a,this._minTemp,this._maxTemp);if(o){const e=this._translateValidationMessage(o);return void this._showAlert($t(this._translations.errors.invalidSchedule,{error:e}))}this._isLoading=!0,this._loadingTimeoutId=window.setTimeout(()=>{this._isLoading=!1,this._loadingTimeoutId=void 0},1e4);try{const{base_temperature:e,periods:s}=a;await this._callSetScheduleWeekday(i,this._currentProfile,t,e,s),this._scheduleData&&(this._scheduleData={...this._scheduleData,[t]:a}),this._updateFromEntity(),this.requestUpdate(),console.info(`Pasted schedule to ${t}`),this._needsManualReload(i)&&this._scheduleReloadDeviceConfig(i)}catch(e){console.error("Failed to paste schedule:",e);const t=String(e);t.includes("unauthorized")||t.includes("Unauthorized")?this._showAlert(this._translations.errors.insufficientPermissions):this._showAlert($t(this._translations.errors.failedToPasteSchedule,{error:t}))}finally{void 0!==this._loadingTimeoutId&&(clearTimeout(this._loadingTimeoutId),this._loadingTimeoutId=void 0),this._isLoading=!1}}async _onSaveSchedule(e){if(!this._config||!this.hass||!this._currentProfile)return;const t=this._getActiveEntityId();if(!t)return;const{weekday:i,blocks:s,baseTemperature:a}=e.detail,o=$e(s,a),n=He(o,this._minTemp,this._maxTemp);if(n){const e=this._translateValidationMessage(n);return void this._showAlert($t(this._translations.errors.invalidSchedule,{error:e}))}this._isLoading=!0,this._loadingTimeoutId=window.setTimeout(()=>{this._isLoading=!1,this._loadingTimeoutId=void 0},1e4);try{const{base_temperature:e,periods:s}=o;await this._callSetScheduleWeekday(t,this._currentProfile,i,e,s),this._scheduleData&&(this._scheduleData={...this._scheduleData,[i]:o}),this._updateFromEntity(),this.requestUpdate(),this._editingWeekday=void 0,this._needsManualReload(t)&&this._scheduleReloadDeviceConfig(t)}catch(e){console.error("Failed to save schedule:",e);const t=String(e);t.includes("unauthorized")||t.includes("Unauthorized")?this._showAlert(this._translations.errors.insufficientPermissions):this._showAlert($t(this._translations.errors.failedToSaveSchedule,{error:t}))}finally{void 0!==this._loadingTimeoutId&&(clearTimeout(this._loadingTimeoutId),this._loadingTimeoutId=void 0),this._isLoading=!1}}_onValidationFailed(e){this._showAlert($t(this._translations.errors.invalidSchedule,{error:e.detail.error}))}_onEditorClosed(){this._editingWeekday=void 0}_getParsedBlocks(e){if(this._scheduleData){const t=this._scheduleData[e];if(!t)return[];const{blocks:i}=we(t);return i}return[]}_exportSchedule(){if(this._currentProfile&&this._scheduleData)try{const e={version:"2.0",profile:this._currentProfile,exported:(new Date).toISOString(),scheduleData:this._scheduleData,format:"simple"},t=JSON.stringify(e,null,2),i=new Blob([t],{type:"application/json"}),s=URL.createObjectURL(i),a=document.createElement("a");a.href=s,a.download=`schedule-${this._currentProfile}-${(new Date).toISOString().split("T")[0]}.json`,document.body.appendChild(a),a.click(),document.body.removeChild(a),URL.revokeObjectURL(s),console.info("Schedule exported successfully")}catch(e){console.error("Failed to export schedule:",e),this._showAlert($t(this._translations.errors.failedToExport,{error:String(e)}))}}_importSchedule(){if(!this._isEditable)return;const e=document.createElement("input");e.type="file",e.accept=".json,application/json",e.onchange=async e=>{const t=e.target.files?.[0];if(t)if(t.name.endsWith(".json")||"application/json"===t.type)try{const e=await t.text();let i,s;try{i=JSON.parse(e)}catch{return void this._showAlert(this._translations.errors.invalidImportFormat)}if(!i||"object"!=typeof i)return void this._showAlert(this._translations.errors.invalidImportFormat);s="scheduleData"in i?i.scheduleData:i;const a=function(e){if(!e||"object"!=typeof e)return{key:"scheduleMustBeObject"};const t=e,i=["MONDAY","TUESDAY","WEDNESDAY","THURSDAY","FRIDAY","SATURDAY","SUNDAY"];for(const e of i){if(!(e in t))return{key:"missingWeekday",params:{weekday:e}};const i=t[e];if(!i||"object"!=typeof i)return{key:"invalidWeekdayData",params:{weekday:e}};if(!("base_temperature"in i)||!("periods"in i))return{key:"invalidWeekdayData",params:{weekday:e}};const s=He(i);if(s)return{key:"weekdayValidationError",params:{weekday:e},nested:s}}return null}(s);if(a){const e=this._translateValidationMessage(a);return void this._showAlert($t(this._translations.errors.invalidImportData,{error:e}))}const o=this._getActiveEntityId();if(!(this._config&&this.hass&&this._currentProfile&&o))return;this._isLoading=!0,this._loadingTimeoutId=window.setTimeout(()=>{this._isLoading=!1,this._loadingTimeoutId=void 0},1e4);try{const e=s;for(const t of ue){const i=e[t];if(i){const{base_temperature:e,periods:s}=i;await this._callSetScheduleWeekday(o,this._currentProfile,t,e,s)}}this._scheduleData=e,this._updateFromEntity(),this.requestUpdate(),console.info("Schedule imported successfully"),this._showAlert(this._translations.ui.importSuccess,"success"),this._needsManualReload(o)&&this._scheduleReloadDeviceConfig(o)}catch(e){console.error("Failed to import schedule:",e),this._showAlert($t(this._translations.errors.failedToImport,{error:String(e)}))}finally{void 0!==this._loadingTimeoutId&&(clearTimeout(this._loadingTimeoutId),this._loadingTimeoutId=void 0),this._isLoading=!1}}catch(e){console.error("Failed to read import file:",e),this._showAlert($t(this._translations.errors.failedToImport,{error:String(e)}))}else this._showAlert(this._translations.errors.invalidImportFile)},e.click()}_buildGridTranslations(){return this._weekdayShortLabelMap||(this._weekdayShortLabelMap=this._createWeekdayLabelMap("short")),this._weekdayLongLabelMap||(this._weekdayLongLabelMap=this._createWeekdayLabelMap("long")),{weekdayShortLabels:this._weekdayShortLabelMap,weekdayLongLabels:this._weekdayLongLabelMap,clickToEdit:this._translations.ui.clickToEdit,copySchedule:this._translations.ui.copySchedule,pasteSchedule:this._translations.ui.pasteSchedule}}_buildEditorTranslations(){return this._weekdayShortLabelMap||(this._weekdayShortLabelMap=this._createWeekdayLabelMap("short")),this._weekdayLongLabelMap||(this._weekdayLongLabelMap=this._createWeekdayLabelMap("long")),{weekdayShortLabels:this._weekdayShortLabelMap,weekdayLongLabels:this._weekdayLongLabelMap,edit:this._translations.ui.edit,cancel:this._translations.ui.cancel,save:this._translations.ui.save,addTimeBlock:this._translations.ui.addTimeBlock,from:this._translations.ui.from,to:this._translations.ui.to,baseTemperature:this._translations.ui.baseTemperature,baseTemperatureDescription:this._translations.ui.baseTemperatureDescription,temperaturePeriods:this._translations.ui.temperaturePeriods,editSlot:this._translations.ui.editSlot,saveSlot:this._translations.ui.saveSlot,cancelSlotEdit:this._translations.ui.cancelSlotEdit,removeSlot:this._translations.ui.removeSlot,close:this._translations.ui.close,undoShortcut:this._translations.ui.undoShortcut,redoShortcut:this._translations.ui.redoShortcut,warningsTitle:this._translations.warnings.title,validationMessages:this._translations.validationMessages}}_renderEntitySelector(e,t){const i=t&&e.includes(t)?t:e[0];return F`
    ...
    `}}e([he({attribute:!1})],St.prototype,"hass",void 0),e([pe()],St.prototype,"_config",void 0),e([pe()],St.prototype,"_currentProfile",void 0),e([pe()],St.prototype,"_activeDeviceProfile",void 0),e([pe()],St.prototype,"_scheduleData",void 0),e([pe()],St.prototype,"_availableProfiles",void 0),e([pe()],St.prototype,"_activeEntityId",void 0),e([pe()],St.prototype,"_editingWeekday",void 0),e([pe()],St.prototype,"_copiedSchedule",void 0),e([pe()],St.prototype,"_isLoading",void 0),e([pe()],St.prototype,"_translations",void 0),e([pe()],St.prototype,"_minTemp",void 0),e([pe()],St.prototype,"_maxTemp",void 0),e([pe()],St.prototype,"_tempStep",void 0),e([pe()],St.prototype,"_alertMessage",void 0),e([pe()],St.prototype,"_alertType",void 0);const kt="homematicip-local-climate-schedule-card";customElements.get(kt)?console.warn(`%c HOMEMATICIP LOCAL %c The standalone HACS card "${kt}" is already loaded. This card is now included with the integration and the HACS version can be removed. Go to HACS → Frontend → remove the climate schedule card resource.`,"color: white; background: #e67e22; font-weight: 700;","color: #e67e22; background: white; font-weight: 700;"):customElements.define(kt,St),window.customCards=window.customCards||[],window.customCards.some(e=>e.type===kt)||window.customCards.push({type:kt,name:"Homematic(IP) Local Climate Schedule Card",description:"Display and edit Homematic thermostat schedules"});const Et=n`
  :host {
    display: block;
...
`,Tt={en:{systemHealth:"System Health",centralState:"Status",healthScore:"Health",devices:"Devices",unreachable:"Unreachable",firmwareUpdates:"FW Updates",incidents:"Incidents",noIncidents:"No incidents",throttleActive:"Throttle active",dutyCycle:"Duty Cycle",carrierSense:"Carrier Sense",deviceStatus:"Device Status",problems:"Problems",allDevicesOk:"All devices OK",notReachable:"Not reachable",lowBattery:"Low battery",configPending:"Config pending",devicesOk:"{count} devices OK",noDevices:"No devices found",messages:"Messages",alarms:"Alarms",serviceMessages:"Service",acknowledge:"Acknowledge",noMessages:"No service messages",noAlarms:"No alarms",loading:"Loading...",error:"Error loading data",refresh:"Refresh"},de:{systemHealth:"Systemstatus",centralState:"Status",healthScore:"Zustand",devices:"Geräte",unreachable:"Nicht erreichbar",firmwareUpdates:"FW-Updates",incidents:"Vorfälle",noIncidents:"Keine Vorfälle",throttleActive:"Drosselung aktiv",dutyCycle:"Duty Cycle",carrierSense:"Carrier Sense",deviceStatus:"Gerätestatus",problems:"Probleme",allDevicesOk:"Alle Geräte OK",notReachable:"Nicht erreichbar",lowBattery:"Batterie niedrig",configPending:"Konfiguration ausstehend",devicesOk:"{count} Geräte OK",noDevices:"Keine Geräte gefunden",messages:"Meldungen",alarms:"Alarme",serviceMessages:"Service",acknowledge:"Quittieren",noMessages:"Keine Servicemeldungen",noAlarms:"Keine Alarme",loading:"Laden...",error:"Fehler beim Laden",refresh:"Aktualisieren"}};function At(e){return Tt[e]||Tt.en}class Dt extends re{constructor(){super(...arguments),this._loading=!0,this._error=""}static{this.styles=Et}setConfig(e){this._config={show_incidents:!1,max_incidents:5,show_throttle:!1,poll_interval:30,...e}}connectedCallback(){super.connectedCallback(),this._fetchData()}disconnectedCallback(){super.disconnectedCallback(),this._stopPolling()}updated(e){e.has("hass")&&this.hass&&(this._t=At(this.hass.config.language))}_startPolling(e){this._stopPolling(),this._pollTimer=setTimeout(()=>this._fetchData(),e)}_stopPolling(){this._pollTimer&&(clearTimeout(this._pollTimer),this._pollTimer=void 0)}async _fetchData(){if(!this.hass||!this._config||!this._config.entry_id)return void(this._loading=!1);try{const e=this._config.show_incidents?this._config.max_incidents:0,[t,i,s]=await Promise.all([ht(this.hass,this._config.entry_id),ut(this.hass,this._config.entry_id),e>0?pt(this.hass,this._config.entry_id,e):Promise.resolve(void 0)]);this._health=t,this._deviceStats=i,s&&(this._incidents=s),this._entryEntityIds||await this._loadEntryEntityIds(),this._error=""}catch(e){this._error=String(e)}finally{this._loading=!1}const e="running"===this._health?.central_state?.toLowerCase(),t=1e3*(this._config.poll_interval??30);this._startPolling(e?Math.max(t,3e4):5e3)}render(){if(!this._config||!this._t)return j;const e=this._config.title??this._t.systemHealth;return this._loading?F`
  ...
  `}}e([he({attribute:!1})],Nt.prototype,"hass",void 0),e([pe()],Nt.prototype,"_config",void 0),e([pe()],Nt.prototype,"_entryOptions",void 0);const Ht="homematicip-device-status-editor";customElements.get(Ht)||customElements.define(Ht,Nt);class Bt extends re{constructor(){super(...arguments),this._serviceMessages=[],this._alarmMessages=[],this._loading=!0,this._error=""}static{this.styles=Et}setConfig(e){this._config={show_service:!0,show_alarms:!0,max_messages:10,show_timestamp:!0,compact:!1,poll_interval:30,...e}}connectedCallback(){super.connectedCallback(),this._fetchData()}disconnectedCallback(){super.disconnectedCallback(),this._stopPolling()}updated(e){e.has("hass")&&this.hass&&(this._t=At(this.hass.config.language))}_startPolling(){this._stopPolling();const e=1e3*(this._config?.poll_interval??30);this._pollTimer=setTimeout(()=>this._fetchData(),e)}_stopPolling(){this._pollTimer&&(clearTimeout(this._pollTimer),this._pollTimer=void 0)}async _fetchData(){if(this.hass&&this._config&&this._config.entry_id){try{const e=[];this._config.show_service&&e.push(async function(e,t){return(await e.callWS({type:"homematicip_local/ccu/get_service_messages",entry_id:t})).messages}(this.hass,this._config.entry_id).then(e=>this._serviceMessages=e)),this._config.show_alarms&&e.push(async function(e,t){return(await e.callWS({type:"homematicip_local/ccu/get_alarm_messages",entry_id:t})).alarms}(this.hass,this._config.entry_id).then(e=>this._alarmMessages=e)),await Promise.all(e),this._error=""}catch(e){this._error=String(e)}finally{this._loading=!1}this._startPolling()}else this._loading=!1}async _acknowledgeService(e){if(this.hass&&this._config)try{await async function(e,t,i){return e.callWS({type:"homematicip_local/ccu/acknowledge_service_message",entry_id:t,msg_id:i})}(this.hass,this._config.entry_id,e),this._serviceMessages=this._serviceMessages.filter(t=>t.msg_id!==e)}catch{}}async _acknowledgeAlarm(e){if(this.hass&&this._config)try{await async function(e,t,i){return e.callWS({type:"homematicip_local/ccu/acknowledge_alarm_message",entry_id:t,alarm_id:i})}(this.hass,this._config.entry_id,e),this._alarmMessages=this._alarmMessages.filter(t=>t.alarm_id!==e)}catch{}}render(){if(!this._config||!this._t)return j;const e=this._config.title??this._t.messages;if(this._loading)return F`
    ...
    `}_formatTimestamp(e){if(!e)return"";try{return new Date(e).toLocaleTimeString(this.hass?.config.language||"en",{hour:"2-digit",minute:"2-digit"})}catch{return e}}static getConfigElement(){return document.createElement("homematicip-messages-editor")}static getStubConfig(){return{entry_id:""}}getCardSize(){return 3}}e([he({attribute:!1})],Bt.prototype,"hass",void 0),e([pe()],Bt.prototype,"_config",void 0),e([pe()],Bt.prototype,"_serviceMessages",void 0),e([pe()],Bt.prototype,"_alarmMessages",void 0),e([pe()],Bt.prototype,"_loading",void 0),e([pe()],Bt.prototype,"_error",void 0);const zt="homematicip-messages-card";customElements.get(zt)||customElements.define(zt,Bt);class Wt extends re{constructor(){super(...arguments),this._entryOptions=[],this._computeLabel=e=>({entry_id:"Integration",title:"Title (optional)",show_alarms:"Show alarms",show_service:"Show service messages",max_messages:"Max messages",show_timestamp:"Show timestamps",poll_interval:"Poll interval"}[e.name]||e.name)}setConfig(e){this._config=e}connectedCallback(){super.connectedCallback(),this._loadEntries()}updated(e){e.has("hass")&&this.hass&&0===this._entryOptions.length&&this._loadEntries()}async _loadEntries(){this.hass&&(this._entryOptions=await Mt(this.hass))}_buildSchema(){return[{name:"entry_id",required:!0,selector:{select:{options:this._entryOptions,mode:"dropdown"}}},{name:"title",selector:{text:{}}},{name:"show_alarms",selector:{boolean:{}},default:!0},{name:"show_service",selector:{boolean:{}},default:!0},{name:"max_messages",selector:{number:{min:1,max:50,mode:"box"}},default:10},{name:"show_timestamp",selector:{boolean:{}},default:!0},{name:"poll_interval",selector:{number:{min:5,max:300,mode:"box",unit_of_measurement:"s"}},default:30}]}render(){return this.hass&&this._config?F`
      <ha-form
        .hass=${this.hass}
        .data=${this._config}
        .schema=${this._buildSchema()}

        ...
        <div class="toolbar">
          <div class="profile-selector">
            <ha-select
              ...
              .options=${e.available_profiles.map(t=>({value:t,label:t+(t===e.active_profile?" ✓":"")}))}
              @selected=${this._handleProfileChange}
              @closed=${e=>e.stopPropagation()}
            ></ha-select>
          </div>

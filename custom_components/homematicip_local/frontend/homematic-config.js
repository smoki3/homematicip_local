...
`,ve=new Set(["BidCos-RF","BidCos-Wired","HmIP-RF"]);async function me(e,t){return(await e.callWS({type:"homematicip_local/config/list_devices",entry_id:t})).devices}async function ge(e,t,i,s,a="",n="MASTER"){return e.callWS({type:"homematicip_local/config/get_form_schema",entry_id:t,interface_id:i,channel_address:s,channel_type:a,paramset_key:n})}async function fe(e,t,i,s,a="MASTER"){return e.callWS({type:"homematicip_local/config/session_open",entry_id:t,interface_id:i,channel_address:s,paramset_key:a})}async function ye(e,t,i,s="MASTER"){return e.callWS({type:"homematicip_local/config/session_discard",entry_id:t,channel_address:i,paramset_key:s})}async function be(e,t,i,s,a){return e.callWS({type:"homematicip_local/config/get_link_form_schema",entry_id:t,interface_id:i,sender_channel_address:s,receiver_channel_address:a})}async function xe(e,t,i,s,a,n){return e.callWS({type:"homematicip_local/config/put_link_paramset",entry_id:t,interface_id:i,sender_channel_address:s,receiver_channel_address:a,values:n})}async function $e(e,t){return(await e.callWS({type:"homematicip_local/config/list_schedule_devices",entry_id:t})).devices}async function ke(e,t,i,s,a,n,r){return e.callWS({type:"homematicip_local/config/set_climate_schedule_weekday",entry_id:t,device_address:i,profile:s,weekday:a,base_temperature:n,simple_weekday_list:r})}async function we(e,t,i,s){return e.callWS({type:"homematicip_local/config/set_device_schedule",entry_id:t,device_address:i,schedule_data:s})}async function Se(e,t,i,s,a){try{return await e.callWS({type:"homematicip_local/config/get_link_profiles",entry_id:t,interface_id:i,sender_channel_address:s,receiver_channel_address:a})}catch{return null}}const Ee={en:{common:{back:"Back",loading:"Loading...",save:"Save",cancel:"Cancel",yes:"Yes",no:"No"},device_list:{title:"Homematic Device Configuration",select_ccu:"CCU",select_placeholder:"Select a CCU...",search_placeholder:"Search devices...",no_entry_selected:"Please select a CCU to view devices.",no_devices:"No configurable devices found.",channels:"channels",unreachable:"Unreachable",reachable:"Reachable",low_battery:"Low battery",config_pending:"Configuration pending"},device_detail:{address:"Address",firmware:"Firmware",channel:"Channel",configure_master:"Configure MASTER",no_master_config:"No MASTER configuration available.",not_found:"Device not found.",yes:"Yes",no:"No",reachable:"Reachable",unreachable:"Unreachable",export:"Export",import:"Import",export_success:"Configuration exported successfully.",export_failed:"Failed to export configuration.",import_confirm_title:"Import Configuration",import_confirm_text:"Import and apply configuration to channel {channel}?",import_success:"Configuration imported successfully.",import_failed:"Failed to import configuration.",import_validation_failed:"Import validation failed.",show_history:"Change History",show_links:"Direct Links",show_schedules:"Schedules",rssi_device:"RSSI Device",rssi_peer:"RSSI Peer",dutycycle:"Duty Cycle",low_bat:"Low Battery",unreach:"Reachability",config_pending_label:"Config Pending"},form_parameter:{toggle_on:"On",toggle_off:"Off"},time_selector:{base:"Base",factor:"Factor"},channel_config:{save:"Save",saving:"Saving...",discard:"Discard Changes",reset_defaults:"Reset to Defaults",confirm_save_title:"Save Changes",confirm_save_text:"Apply {count} change(s) to the device?",unsaved_title:"Unsaved Changes",unsaved_warning:"You have unsaved changes. Discard them and go back?",save_success:"Changes saved successfully.",save_failed:"Failed to save changes.",validation_failed:"Validation failed. Please check the highlighted fields.",undo:"Undo",redo:"Redo"},change_history:{title:"Change History",empty:"No configuration changes recorded.",clear:"Clear History",clear_confirm_title:"Clear History",clear_confirm_text:"Delete all history entries? This cannot be undone.",clear_success:"History cleared ({count} entries removed).",source_manual:"Manual",source_import:"Import",source_copy:"Copy",parameters_changed:"{count} parameter(s) changed"},device_links:{title:"Direct Links",subtitle:"Direct links for {device}",empty:"No direct links configured.",add_link:"New Link",outgoing:"Outgoing",incoming:"Incoming",configure:"Configure",delete:"Delete",delete_confirm_title:"Delete Link",delete_confirm_text:"Remove the direct link from {sender} to {receiver}? The devices will no longer communicate directly.",delete_success:"Link deleted successfully.",delete_failed:"Failed to delete link.",channel_group:"Channel {channel}"},link_config:{title:"Link Configuration",sender:"Sender",receiver:"Receiver",save_success:"Link configuration saved.",save_failed:"Failed to save link configuration.",discard:"Discard Changes",confirm_save_title:"Save Link Changes",confirm_save_text:"Apply {count} change(s) to this link?",unsaved_title:"Unsaved Changes",unsaved_warning:"You have unsaved changes. Discard them and go back?",receiver_params:"Receiver Parameters",sender_params:"Sender Parameters",no_params:"No configurable parameters for this link.",profile:"Profile",short_keypress:"Short keypress",long_keypress:"Long keypress",last_value:"Last value",custom_time:"Custom"},device_schedule:{title:"Schedules",subtitle:"Schedules for {device}",select_device:"Select a device...",no_devices:"No devices with schedule support found.",schedule_type_climate:"Climate",schedule_type_default:"Device",profile:"Profile",active_profile:"Active profile",weekdays:"Mon,Tue,Wed,Thu,Fri,Sat,Sun",weekday_monday:"Monday",weekday_tuesday:"Tuesday",weekday_wednesday:"Wednesday",weekday_thursday:"Thursday",weekday_friday:"Friday",weekday_saturday:"Saturday",weekday_sunday:"Sunday",base_temperature:"Base temperature",temperature:"Temperature",time:"Time",from:"From",to:"To",add_period:"Add period",delete_period:"Delete",save:"Save",saving:"Saving...",save_success:"Schedule saved successfully.",save_failed:"Failed to save schedule.",load_failed:"Failed to load schedule.",reload:"Reload from device",reload_success:"Device configuration reloaded.",reload_failed:"Failed to reload device configuration.",export:"Export",import:"Import",import_confirm_title:"Import Schedule",import_confirm_text:"Import and apply this schedule?",import_success:"Schedule imported.",import_failed:"Failed to import schedule.",no_schedule_data:"No schedule data available.",click_to_edit:"Click on a time slot to edit the schedule",copy_schedule:"Copy schedule",paste_schedule:"Paste schedule",edit:"Edit {weekday}",add_time_block:"+ Add Time Block",edit_slot:"Edit",save_slot:"Save",cancel_slot_edit:"Cancel",undo_shortcut:"Undo (Ctrl+Z)",redo_shortcut:"Redo (Ctrl+Y)",warnings_title:"Validation Warnings",base_temperature_description:"Temperature for unscheduled periods",temperature_periods:"Temperature Periods",invalid_schedule:"Invalid schedule: {error}",validation_block_end_before_start:"Block {block}: End time is before start time",validation_block_zero_duration:"Block {block}: Block has zero duration",validation_invalid_start_time:"Block {block}: Invalid start time",validation_invalid_end_time:"Block {block}: Invalid end time",validation_temp_out_of_range:"Block {block}: Temperature out of range ({min}-{max}°C)",validation_invalid_slot_count:"Invalid number of slots: {count} (expected 13)",validation_invalid_slot_key:"Invalid slot key: {key} (must be integer 1-13)",validation_missing_slot:"Missing slot {slot}",validation_slot_missing_values:"Slot {slot} missing ENDTIME or TEMPERATURE",validation_slot_time_backwards:"Slot {slot} time goes backwards: {time}",validation_slot_time_exceeds_day:"Slot {slot} time exceeds 24:00: {time}",validation_last_slot_must_end:"Last slot must end at 24:00",validation_schedule_must_be_object:"Schedule data must be an object",validation_missing_weekday:"Missing weekday: {weekday}",validation_invalid_weekday_data:"Invalid data for {weekday}",validation_weekday_error:"{weekday}: {details}",entries:"{count} entries",max_entries:"Max entries: {max}",level:"Level",duration:"Duration",condition:"Condition",target_channel:"Target channel",add_event:"Add Event",edit_event:"Edit Event",confirm_delete:"Are you sure you want to delete this event?",weekdays_label:"Weekdays",level_on:"On",level_off:"Off",slat:"Slat Position",ramp_time:"Ramp Time",astro_sunrise:"Sunrise",astro_sunset:"Sunset",astro_offset:"Astro Offset (min)",condition_fixed_time:"Fixed Time",condition_astro:"Astro",condition_fixed_if_before_astro:"Fixed if before Astro",condition_astro_if_before_fixed:"Astro if before Fixed",condition_fixed_if_after_astro:"Fixed if after Astro",condition_astro_if_after_fixed:"Astro if after Fixed",condition_earliest:"Earliest",condition_latest:"Latest"},add_link:{title:"New Direct Link",step_channel:"Step 1/3 — Select Channel",step_peer:"Step 2/3 — Select Partner",step_confirm:"Step 3/3 — Confirm",select_channel:"Select a channel from this device:",select_role:"Role of selected channel:",role_sender:"Sender (sends commands)",role_receiver:"Receiver (receives commands)",search_devices:"Search devices...",no_compatible:"No compatible channels found.",link_name:"Link name (optional)",create:"Create Link",create_success:"Link created successfully.",create_failed:"Failed to create link.",next:"Next",back:"Back"}},de:{common:{back:"Zurück",loading:"Laden...",save:"Speichern",cancel:"Abbrechen",yes:"Ja",no:"Nein"},device_list:{title:"Homematic Gerätekonfiguration",select_ccu:"CCU",select_placeholder:"CCU auswählen...",search_placeholder:"Geräte suchen...",no_entry_selected:"Bitte eine CCU auswählen, um Geräte anzuzeigen.",no_devices:"Keine konfigurierbaren Geräte gefunden.",channels:"Kanäle",unreachable:"Nicht erreichbar",reachable:"Erreichbar",low_battery:"Batterie schwach",config_pending:"Konfiguration ausstehend"},device_detail:{address:"Adresse",firmware:"Firmware",channel:"Kanal",configure_master:"MASTER konfigurieren",no_master_config:"Keine MASTER-Konfiguration verfügbar.",not_found:"Gerät nicht gefunden.",yes:"Ja",no:"Nein",reachable:"Erreichbar",unreachable:"Nicht erreichbar",export:"Exportieren",import:"Importieren",export_success:"Konfiguration erfolgreich exportiert.",export_failed:"Export der Konfiguration fehlgeschlagen.",import_confirm_title:"Konfiguration importieren",import_confirm_text:"Konfiguration importieren und auf Kanal {channel} anwenden?",import_success:"Konfiguration erfolgreich importiert.",import_failed:"Import der Konfiguration fehlgeschlagen.",import_validation_failed:"Import-Validierung fehlgeschlagen.",show_history:"Änderungsverlauf",show_links:"Direktverknüpfungen",show_schedules:"Zeitpläne",rssi_device:"RSSI Gerät",rssi_peer:"RSSI Peer",dutycycle:"Duty Cycle",low_bat:"Batterie schwach",unreach:"Erreichbarkeit",config_pending_label:"Konfig. ausstehend"},form_parameter:{toggle_on:"Ein",toggle_off:"Aus"},time_selector:{base:"Basis",factor:"Faktor"},channel_config:{save:"Speichern",saving:"Speichern...",discard:"Änderungen verwerfen",reset_defaults:"Standardwerte laden",confirm_save_title:"Änderungen speichern",confirm_save_text:"{count} Änderung(en) auf das Gerät anwenden?",unsaved_title:"Ungespeicherte Änderungen",unsaved_warning:"Es gibt ungespeicherte Änderungen. Verwerfen und zurückgehen?",save_success:"Änderungen erfolgreich gespeichert.",save_failed:"Fehler beim Speichern der Änderungen.",validation_failed:"Validierung fehlgeschlagen. Bitte die markierten Felder prüfen.",undo:"Rückgängig",redo:"Wiederherstellen"},change_history:{title:"Änderungsverlauf",empty:"Keine Konfigurationsänderungen aufgezeichnet.",clear:"Verlauf löschen",clear_confirm_title:"Verlauf löschen",clear_confirm_text:"Alle Verlaufseinträge löschen? Dies kann nicht rückgängig gemacht werden.",clear_success:"Verlauf gelöscht ({count} Einträge entfernt).",source_manual:"Manuell",source_import:"Import",source_copy:"Kopie",parameters_changed:"{count} Parameter geändert"},device_links:{title:"Direktverknüpfungen",subtitle:"Direktverknüpfungen für {device}",empty:"Keine Direktverknüpfungen konfiguriert.",add_link:"Neue Verknüpfung",outgoing:"Ausgehend",incoming:"Eingehend",configure:"Konfigurieren",delete:"Löschen",delete_confirm_title:"Verknüpfung löschen",delete_confirm_text:"Direktverknüpfung von {sender} nach {receiver} entfernen? Die Geräte kommunizieren dann nicht mehr direkt.",delete_success:"Verknüpfung erfolgreich gelöscht.",delete_failed:"Fehler beim Löschen der Verknüpfung.",channel_group:"Kanal {channel}"},link_config:{title:"Link-Konfiguration",sender:"Sender",receiver:"Empfänger",save_success:"Link-Konfiguration gespeichert.",save_failed:"Fehler beim Speichern der Link-Konfiguration.",discard:"Änderungen verwerfen",confirm_save_title:"Link-Änderungen speichern",confirm_save_text:"{count} Änderung(en) auf diese Verknüpfung anwenden?",unsaved_title:"Ungespeicherte Änderungen",unsaved_warning:"Es gibt ungespeicherte Änderungen. Verwerfen und zurückgehen?",receiver_params:"Empfänger-Parameter",sender_params:"Sender-Parameter",no_params:"Keine konfigurierbaren Parameter für diese Verknüpfung.",profile:"Profil",short_keypress:"Kurzer Tastendruck",long_keypress:"Langer Tastendruck",last_value:"Letzter Wert",custom_time:"Benutzerdefiniert"},device_schedule:{title:"Zeitpläne",subtitle:"Zeitpläne für {device}",select_device:"Gerät auswählen...",no_devices:"Keine Geräte mit Zeitplan-Unterstützung gefunden.",schedule_type_climate:"Heizung",schedule_type_default:"Gerät",profile:"Profil",active_profile:"Aktives Profil",weekdays:"Mo,Di,Mi,Do,Fr,Sa,So",weekday_monday:"Montag",weekday_tuesday:"Dienstag",weekday_wednesday:"Mittwoch",weekday_thursday:"Donnerstag",weekday_friday:"Freitag",weekday_saturday:"Samstag",weekday_sunday:"Sonntag",base_temperature:"Basistemperatur",temperature:"Temperatur",time:"Uhrzeit",from:"Von",to:"Bis",add_period:"Zeitraum hinzufügen",delete_period:"Löschen",save:"Speichern",saving:"Speichern...",save_success:"Zeitplan erfolgreich gespeichert.",save_failed:"Fehler beim Speichern des Zeitplans.",load_failed:"Fehler beim Laden des Zeitplans.",reload:"Vom Gerät laden",reload_success:"Gerätekonfiguration neu geladen.",reload_failed:"Fehler beim Laden der Gerätekonfiguration.",export:"Exportieren",import:"Importieren",import_confirm_title:"Zeitplan importieren",import_confirm_text:"Diesen Zeitplan importieren und anwenden?",import_success:"Zeitplan importiert.",import_failed:"Fehler beim Importieren des Zeitplans.",no_schedule_data:"Keine Zeitplan-Daten verfügbar.",click_to_edit:"Klicken Sie auf einen Zeitabschnitt, um den Zeitplan zu bearbeiten",copy_schedule:"Zeitplan kopieren",paste_schedule:"Zeitplan einfügen",edit:"{weekday} bearbeiten",add_time_block:"+ Zeitblock hinzufügen",edit_slot:"Bearbeiten",save_slot:"Speichern",cancel_slot_edit:"Abbrechen",undo_shortcut:"Rückgängig (Strg+Z)",redo_shortcut:"Wiederholen (Strg+Y)",warnings_title:"Validierungswarnungen",base_temperature_description:"Temperatur für nicht geplante Zeiträume",temperature_periods:"Temperaturperioden",invalid_schedule:"Ungültiger Zeitplan: {error}",validation_block_end_before_start:"Block {block}: Die Endzeit liegt vor der Startzeit",validation_block_zero_duration:"Block {block}: Der Block hat keine Dauer",validation_invalid_start_time:"Block {block}: Ungültige Startzeit",validation_invalid_end_time:"Block {block}: Ungültige Endzeit",validation_temp_out_of_range:"Block {block}: Temperatur außerhalb des Bereichs ({min}-{max}°C)",validation_invalid_slot_count:"Ungültige Anzahl an Slots: {count} (erwartet 13)",validation_invalid_slot_key:"Ungültiger Slot-Schlüssel: {key} (muss eine Ganzzahl 1-13 sein)",validation_missing_slot:"Slot {slot} fehlt",validation_slot_missing_values:"Slot {slot} fehlt ENDTIME oder TEMPERATURE",validation_slot_time_backwards:"Slot {slot}: Zeit läuft rückwärts: {time}",validation_slot_time_exceeds_day:"Slot {slot}: Zeit überschreitet 24:00: {time}",validation_last_slot_must_end:"Der letzte Slot muss um 24:00 enden",validation_schedule_must_be_object:"Zeitplandaten müssen ein Objekt sein",validation_missing_weekday:"Fehlender Wochentag: {weekday}",validation_invalid_weekday_data:"Ungültige Daten für {weekday}",validation_weekday_error:"{weekday}: {details}",entries:"{count} Einträge",max_entries:"Max. Einträge: {max}",level:"Wert",duration:"Dauer",condition:"Bedingung",target_channel:"Zielkanal",add_event:"Ereignis hinzufügen",edit_event:"Ereignis bearbeiten",confirm_delete:"Möchten Sie dieses Ereignis wirklich löschen?",weekdays_label:"Wochentage",level_on:"Ein",level_off:"Aus",slat:"Lamellenposition",ramp_time:"Rampenzeit",astro_sunrise:"Sonnenaufgang",astro_sunset:"Sonnenuntergang",astro_offset:"Astro-Offset (Min.)",condition_fixed_time:"Feste Zeit",condition_astro:"Astro",condition_fixed_if_before_astro:"Fest wenn vor Astro",condition_astro_if_before_fixed:"Astro wenn vor Fest",condition_fixed_if_after_astro:"Fest wenn nach Astro",condition_astro_if_after_fixed:"Astro wenn nach Fest",condition_earliest:"Frühester",condition_latest:"Spätester"},add_link:{title:"Neue Direktverknüpfung",step_channel:"Schritt 1/3 — Kanal wählen",step_peer:"Schritt 2/3 — Partner wählen",step_confirm:"Schritt 3/3 — Bestätigen",select_channel:"Kanal dieses Geräts auswählen:",select_role:"Rolle des gewählten Kanals:",role_sender:"Sender (sendet Kommandos)",role_receiver:"Empfänger (empfängt Kommandos)",search_devices:"Geräte suchen...",no_compatible:"Keine kompatiblen Kanäle gefunden.",link_name:"Verknüpfungsname (optional)",create:"Verknüpfung erstellen",create_success:"Verknüpfung erfolgreich erstellt.",create_failed:"Fehler beim Erstellen der Verknüpfung.",next:"Weiter",back:"Zurück"}}};function Ce(e,t=""){const i={};for(const[s,a]of Object.entries(e)){const e=t?`${t}.${s}`:s;"string"==typeof a?i[e]=a:"object"==typeof a&&null!==a&&Object.assign(i,Ce(a,e))}return i}const Ae=new Map;function De(e){if(Ae.has(e))return Ae.get(e);const t=Ce(Ee[e]??Ee.en);return Ae.set(e,t),t}function Te(e,t,i){const s=De(e.config.language??"en");let a=s[t]??s[t.replace(/^panel\./,"")]??t;if(i)for(const[e,t]of Object.entries(i))a=a.replace(`{${e}}`,String(t));return a}let Ie=class extends oe{constructor(){super(...arguments),this.entryId="",this.entries=[],this._devices=[],this._loading=!1,this._searchQuery="",this._error=""}updated(e){e.has("entryId")&&this.entryId&&this._fetchDevices()}async _fetchDevices(){if(this.entryId){this._loading=!0,this._error="";try{this._devices=await me(this.hass,this.entryId)}catch(e){this._error=String(e),this._devices=[]}finally{this._loading=!1}}}_l(e,t){return Te(this.hass,e,t)}get _filteredDevices(){if(!this._searchQuery)return this._devices;const e=this._searchQuery.toLowerCase();return this._devices.filter(t=>t.name.toLowerCase().includes(e)||t.address.toLowerCase().includes(e)||t.model.toLowerCase().includes(e))}get _groupedDevices(){const e=[...this._filteredDevices].sort((e,t)=>e.name.localeCompare(t.name)),t=new Map;for(const i of e){const e=i.interface_id.split("-").slice(1).join("-")||i.interface_id;t.has(e)||t.set(e,[]),t.get(e).push(i)}return t}_handleEntryChanged(e){this.dispatchEvent(new CustomEvent("entry-changed",{detail:{entryId:e.target.value},bubbles:!0,composed:!0}))}_handleDeviceClick(e){this.dispatchEvent(new CustomEvent("device-selected",{detail:{device:e.address,interfaceId:e.interface_id},bubbles:!0,composed:!0}))}_renderMaintenanceIcons(e){return e&&0!==Object.keys(e).length?W`
    ...
    `]}};function Me(e,t){return new Promise(e=>{const i=document.createElement("dialog");i.style.cssText=["border: none","border-radius: var(--ha-card-border-radius, 12px)","padding: 24px","max-width: 450px","width: calc(100% - 48px)","box-shadow: 0 8px 32px rgba(0, 0, 0, 0.3)","font-family: var(--paper-font-body1_-_font-family, Roboto, sans-serif)","background: var(--card-background-color, var(--ha-card-background, #fff))","color: var(--primary-text-color, #212121)"].join("; ");const s=t.title?`<h2 style="margin: 0 0 16px; font-size: 18px; font-weight: 500;">${Pe(t.title)}</h2>`:"",a=t.text?`<p style="margin: 0 0 24px; white-space: pre-line; line-height: 1.5; color: var(--secondary-text-color, #727272);">${Pe(t.text)}</p>`:"",n=t.destructive?"var(--error-color, #db4437)":"var(--primary-color, #03a9f4)";i.innerHTML=`\n      ${s}\n      ${a}\n      <div style="display: flex; justify-content: flex-end; gap: 8px;">\n        <button class="dismiss" style="\n          padding: 8px 16px;\n          border: none;\n          border-radius: 4px;\n          background: transparent;\n          color: var(--primary-text-color, #212121);\n          font-size: 14px;\n          font-family: inherit;\n          cursor: pointer;\n        ">${Pe(t.dismissText||"Cancel")}</button>\n        <button class="confirm" style="\n          padding: 8px 16px;\n          border: none;\n          border-radius: 4px;\n          background: ${n};\n          color: #fff;\n          font-size: 14px;\n          font-family: inherit;\n          cursor: pointer;\n        ">${Pe(t.confirmText||"OK")}</button>\n      </div>\n    `;const r=t=>{i.close(),i.remove(),e(t)};i.querySelector(".confirm").addEventListener("click",()=>r(!0)),i.querySelector(".dismiss").addEventListener("click",()=>r(!1)),i.addEventListener("cancel",e=>{e.preventDefault(),r(!1)}),document.body.appendChild(i),i.showModal()})}function Pe(e){const t=document.createElement("div");return t.textContent=e,t.innerHTML}function Le(e,t){const i=new CustomEvent("hass-notification",{bubbles:!0,composed:!0,detail:t});e.dispatchEvent(i)}e([he({attribute:!1})],Ie.prototype,"hass",void 0),e([he()],Ie.prototype,"entryId",void 0),e([he({attribute:!1})],Ie.prototype,"entries",void 0),e([pe()],Ie.prototype,"_devices",void 0),e([pe()],Ie.prototype,"_loading",void 0),e([pe()],Ie.prototype,"_searchQuery",void 0),e([pe()],Ie.prototype,"_error",void 0),Ie=e([_e("hm-device-list")],Ie);let ze=class extends oe{constructor(){super(...arguments),this.entryId="",this.interfaceId="",this.deviceAddress="",this._device=null,this._hasSchedule=!1,this._loading=!0,this._error=""}updated(e){(e.has("entryId")||e.has("deviceAddress"))&&this.entryId&&this.deviceAddress&&this._fetchDevice()}async _fetchDevice(){this._loading=!0,this._error="";try{const[e,t]=await Promise.all([me(this.hass,this.entryId),$e(this.hass,this.entryId).catch(()=>[])]);this._device=e.find(e=>e.address===this.deviceAddress)??null,this._hasSchedule=t.some(e=>e.address===this.deviceAddress)}catch(e){this._error=String(e)}finally{this._loading=!1}}_l(e,t){return Te(this.hass,e,t)}_handleBack(){this.dispatchEvent(new CustomEvent("back",{bubbles:!0,composed:!0}))}_handleChannelClick(e){this.dispatchEvent(new CustomEvent("channel-selected",{detail:{channel:e.address,interfaceId:this.interfaceId,channelType:e.channel_type,paramsetKey:"MASTER",deviceName:this._device?.name||this.deviceAddress},bubbles:!0,composed:!0}))}_handleShowHistory(){this.dispatchEvent(new CustomEvent("show-history",{detail:{device:this.deviceAddress},bubbles:!0,composed:!0}))}_handleShowLinks(){this.dispatchEvent(new CustomEvent("show-links",{detail:{device:this.deviceAddress,interfaceId:this.interfaceId,deviceName:this._device?.name||this.deviceAddress},bubbles:!0,composed:!0}))}_handleShowSchedules(){this.dispatchEvent(new CustomEvent("show-schedules",{detail:{device:this.deviceAddress,interfaceId:this.interfaceId,deviceName:this._device?.name||this.deviceAddress},bubbles:!0,composed:!0}))}async _handleExport(e){try{const t=await async function(e,t,i,s,a="MASTER"){return e.callWS({type:"homematicip_local/config/export_paramset",entry_id:t,interface_id:i,channel_address:s,paramset_key:a})}(this.hass,this.entryId,this.interfaceId,e.address,"MASTER"),i=new Blob([t.json_data],{type:"application/json"}),s=URL.createObjectURL(i),a=document.createElement("a");a.href=s,a.download=`${e.address.replace(/:/g,"_")}_MASTER.json`,a.click(),URL.revokeObjectURL(s),Le(this,{message:this._l("device_detail.export_success")})}catch{Le(this,{message:this._l("device_detail.export_failed")})}}async _handleImport(e){const t=document.createElement("input");t.type="file",t.accept=".json",t.onchange=async()=>{const i=t.files?.[0];if(i)try{const t=await i.text();if(!await Me(0,{title:this._l("device_detail.import_confirm_title"),text:this._l("device_detail.import_confirm_text",{channel:e.address}),confirmText:this._l("device_detail.import"),dismissText:this._l("common.cancel")}))return;const s=await async function(e,t,i,s,a,n="MASTER"){return e.callWS({type:"homematicip_local/config/import_paramset",entry_id:t,interface_id:i,channel_address:s,json_data:a,paramset_key:n})}(this.hass,this.entryId,this.interfaceId,e.address,t,"MASTER");Le(this,s.success?{message:this._l("device_detail.import_success")}:{message:this._l("device_detail.import_validation_failed")})}catch{Le(this,{message:this._l("device_detail.import_failed")})}},t.click()}render(){if(this._loading)return W`<div class="loading">${this._l("common.loading")}</div>`;if(this._error)return W`<div class="error">${this._error}</div>`;if(!this._device)return W`<div class="empty-state">${this._l("device_detail.not_found")}</div>`;const e=this._device,t=e.channels.find(e=>e.address.endsWith(":0")),i=e.channels.filter(e=>!e.address.endsWith(":0"));return W`
      <ha-icon-button
        class="back-button"
    ...
    `]}};e([he({attribute:!1})],ze.prototype,"hass",void 0),e([he()],ze.prototype,"entryId",void 0),e([he()],ze.prototype,"interfaceId",void 0),e([he()],ze.prototype,"deviceAddress",void 0),e([pe()],ze.prototype,"_device",void 0),e([pe()],ze.prototype,"_hasSchedule",void 0),e([pe()],ze.prototype,"_loading",void 0),e([pe()],ze.prototype,"_error",void 0),ze=e([_e("hm-device-detail")],ze);let Ne=class extends oe{constructor(){super(...arguments),this.value=null,this.modified=!1,this.validationError=""}_emitChange(e){this.dispatchEvent(new CustomEvent("value-changed",{detail:{parameterId:this.parameter.id,value:e,currentValue:this.parameter.current_value},bubbles:!0,composed:!0}))}render(){const e=this.parameter,t=!e.writable;return W`
    ...
    `}_renderWidget(e,t){switch(e.widget){case"toggle":return W`
        ...
        `;case"slider_with_input":return W`
          <div class="slider-group">
            <ha-slider
              ...
              .disabled=${t}
              @value-changed=${t=>{t.stopPropagation();const i=Number(t.detail.value);this._emitChange("integer"===e.type?Math.round(i):i)}}
            ></ha-slider>
            <input
              type="number"
              class="number-input"
        ...
        `;case"dropdown":return W`
          <ha-select
            ...
            .disabled=${t}
            @selected=${e=>{this._emitChange(parseInt(e.target.value,10))}}
            @value-changed=${e=>e.stopPropagation()}
          >
            ${(e.options??[]).map((e,t)=>W`
                <ha-list-item .value=${String(t)} ?selected=${this.value===t}>
                  ${e}
                </ha-list-item>
              `)}
          </ha-select>
        ...
        `;default:return W`<span class="read-only-value">${String(this.value??"")}</span>`}}static{this.styles=[ue,r`
      .read-only {
        opacity: 0.7;
      }
    ...
    `]}};e([he({attribute:!1})],He.prototype,"hass",void 0),e([he()],He.prototype,"entryId",void 0),e([he()],He.prototype,"interfaceId",void 0),e([he()],He.prototype,"deviceAddress",void 0),e([he()],He.prototype,"deviceName",void 0),e([pe()],He.prototype,"_links",void 0),e([pe()],He.prototype,"_loading",void 0),e([pe()],He.prototype,"_error",void 0),He=e([_e("hm-device-links")],He);let Oe=class extends oe{constructor(){super(...arguments),this.baseValue=0,this.factorValue=0,this.presets=[],this.modified=!1,this._isCustom=!1}_l(e){return Te(this.hass,e)}get _matchesPreset(){return this.presets.some(e=>e.base===this.baseValue&&e.factor===this.factorValue)}_emitChange(e,t,i){this.dispatchEvent(new CustomEvent("value-changed",{detail:{parameterId:e,value:t,currentValue:i},bubbles:!0,composed:!0}))}_handlePresetChange(e){const t=e.target.value;if("custom"===t)return void(this._isCustom=!0);this._isCustom=!1;const[i,s]=t.split("-"),a=Number(i),n=Number(s);this._emitChange(this.baseParam.id,a,this.baseParam.current_value),this._emitChange(this.factorParam.id,n,this.factorParam.current_value)}_handleBaseChange(e){const t=Number(e.target.value);this._emitChange(this.baseParam.id,t,this.baseParam.current_value)}_handleFactorChange(e){const t=Number(e.target.value);this._emitChange(this.factorParam.id,t,this.factorParam.current_value)}render(){const e=this.baseParam.label.replace(/ Base$/,"").replace(/ Basis$/,""),t=this._matchesPreset,i=this._isCustom&&!t;return W`
    ...
    `]}};function je(e){return t=>(customElements.get(e)||customElements.define(e,t),t)}e([he({attribute:!1})],We.prototype,"hass",void 0),e([he()],We.prototype,"entryId",void 0),e([he()],We.prototype,"interfaceId",void 0),e([he()],We.prototype,"deviceAddress",void 0),e([pe()],We.prototype,"_step",void 0),e([pe()],We.prototype,"_device",void 0),e([pe()],We.prototype,"_selectedChannel",void 0),e([pe()],We.prototype,"_selectedRole",void 0),e([pe()],We.prototype,"_selectedPeer",void 0),e([pe()],We.prototype,"_linkName",void 0),e([pe()],We.prototype,"_linkableChannels",void 0),e([pe()],We.prototype,"_filteredChannels",void 0),e([pe()],We.prototype,"_searchQuery",void 0),e([pe()],We.prototype,"_loading",void 0),e([pe()],We.prototype,"_error",void 0),We=e([_e("hm-add-link")],We);let Fe=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}};const{I:Ke}=ae,Ye=e=>e,Ze=()=>document.createComment(""),Ge=(e,t,i)=>{const s=e._$AA.parentNode,a=void 0===t?e._$AB:t._$AA;if(void 0===i){const t=s.insertBefore(Ze(),a),n=s.insertBefore(Ze(),a);i=new Ke(t,n,e,e.options)}else{const t=i._$AB.nextSibling,n=i._$AM,r=n!==e;if(r){let t;i._$AQ?.(e),i._$AM=e,void 0!==i._$AP&&(t=e._$AU)!==n._$AU&&i._$AP(t)}if(t!==a||r){let e=i._$AA;for(;e!==t;){const t=Ye(e).nextSibling;Ye(s).insertBefore(e,a),e=t}}}return i},Je=(e,t,i=e)=>(e._$AI(t,i),e),qe={},Qe=(e,t=qe)=>e._$AH=t,Xe=e=>{e._$AR(),e._$AA.remove()},et=(e,t,i)=>{const s=new Map;for(let a=t;a<=i;a++)s.set(e[a],a);return s},tt=(e=>(...t)=>({_$litDirective$:e,values:t}))(class extends Fe{constructor(e){if(super(e),2!==e.type)throw Error("repeat() can only be used in text expressions")}dt(e,t,i){let s;void 0===i?i=t:void 0!==t&&(s=t);const a=[],n=[];let r=0;for(const t of e)a[r]=s?s(t,r):r,n[r]=i(t,r),r++;return{values:n,keys:a}}render(e,t,i){return this.dt(e,t,i).values}update(e,[t,i,s]){const a=(e=>e._$AH)(e),{values:n,keys:r}=this.dt(t,i,s);if(!Array.isArray(a))return this.ut=r,n;const o=this.ut??=[],d=[];let l,c,h=0,p=a.length-1,_=0,u=n.length-1;for(;h<=p&&_<=u;)if(null===a[h])h++;else if(null===a[p])p--;else if(o[h]===r[_])d[_]=Je(a[h],n[_]),h++,_++;else if(o[p]===r[u])d[u]=Je(a[p],n[u]),p--,u--;else if(o[h]===r[u])d[u]=Je(a[h],n[u]),Ge(e,d[u+1],a[h]),h++,u--;else if(o[p]===r[_])d[_]=Je(a[p],n[_]),Ge(e,a[h],a[p]),p--,_++;else if(void 0===l&&(l=et(r,_,u),c=et(o,h,p)),l.has(o[h]))if(l.has(o[p])){const t=c.get(r[_]),i=void 0!==t?a[t]:null;if(null===i){const t=Ge(e,a[h]);Je(t,n[_]),d[_]=t}else d[_]=Je(i,n[_]),Ge(e,a[h],i),a[t]=null;_++}else Xe(a[p]),p--;else Xe(a[h]),h++;for(;_<=u;){const t=Ge(e,d[u+1]);Je(t,n[_]),d[_++]=t}for(;h<=p;){const e=a[h++];null!==e&&Xe(e)}return this.ut=r,Qe(e,d),j}}),it=["MONDAY","TUESDAY","WEDNESDAY","THURSDAY","FRIDAY","SATURDAY","SUNDAY"],st=["fixed_time","astro","fixed_if_before_astro","astro_if_before_fixed","fixed_if_after_astro","astro_if_after_fixed","earliest","latest"],at={switch:{levelType:"binary",hasLevel2:!1,hasDuration:!0,hasRampTime:!1},light:{levelType:"percentage",hasLevel2:!1,hasDuration:!0,hasRampTime:!0},cover:{levelType:"percentage",hasLevel2:!0,hasDuration:!1,hasRampTime:!1},valve:{levelType:"percentage",hasLevel2:!1,hasDuration:!0,hasRampTime:!1}},nt=["ms","s","min","h"];function rt(e){const[t,i]=e.split(":").map(Number);return 60*t+i}function ot(e){const t=e%60;return`${Math.floor(e/60).toString().padStart(2,"0")}:${t.toString().padStart(2,"0")}`}function dt(e,t="24"){if("24"===t)return e;const[i,s]=e.split(":");let a=parseInt(i,10);if(24===a)return"12:00 AM";const n=a>=12?"PM":"AM";return 0===a?a=12:a>12&&(a-=12),`${a}:${s||"00"} ${n}`}function lt(e){return e<10?"#2b9af9":e<14?"#40c4ff":e<17?"#26c6da":e<19?"#66bb6a":e<21?"#9ccc65":e<23?"#ffb74d":e<25?"#ff8100":"#f4511e"}function ct(e){const{base_temperature:t,periods:i}=e,s=[],a=[...i].sort((e,t)=>rt(e.starttime)-rt(t.starttime));for(let e=0;e<a.length;e++){const t=a[e];s.push({startTime:t.starttime,startMinutes:rt(t.starttime),endTime:t.endtime,endMinutes:rt(t.endtime),temperature:t.temperature,slot:e+1})}return{blocks:s,baseTemperature:t}}function ht(e,t){const i=[],s=[...e].sort((e,t)=>e.startMinutes-t.startMinutes);for(const e of s)i.push({starttime:e.startTime,endtime:e.endTime,temperature:e.temperature});return{base_temperature:t,periods:i}}function pt(e){if(0===e.length)return[];const t=[...e].sort((e,t)=>e.startMinutes-t.startMinutes),i=[];let s={...t[0]};for(let e=1;e<t.length;e++){const a=t[e];s.endMinutes===a.startMinutes&&s.temperature===a.temperature?s={...s,endTime:a.endTime,endMinutes:a.endMinutes}:(i.push(s),s={...a})}return i.push(s),i.map((e,t)=>({...e,slot:t+1}))}function _t(e,t){if(0===e.length)return[{startTime:"00:00",startMinutes:0,endTime:"24:00",endMinutes:1440,temperature:t,slot:1}];const i=[...e].sort((e,t)=>e.startMinutes-t.startMinutes),s=[];let a=0;for(const e of i)e.startMinutes>a&&s.push({startTime:ot(a),startMinutes:a,endTime:e.startTime,endMinutes:e.startMinutes,temperature:t,slot:s.length+1}),s.push({...e,slot:s.length+1}),a=e.endMinutes;return a<1440&&s.push({startTime:ot(a),startMinutes:a,endTime:"24:00",endMinutes:1440,temperature:t,slot:s.length+1}),pt(s)}function ut(e){return[...e].sort((e,t)=>e.startMinutes-t.startMinutes).map((e,t)=>({...e,slot:t+1}))}function vt(e){return Boolean(Array.isArray(e.weekdays)&&e.weekdays.length>0&&Array.isArray(e.target_channels)&&e.target_channels.length>0)}function mt(e){return"fixed_time"!==e}const gt=/^(\d+(?:\.\d+)?)\s*(ms|s|min|h)$/;function ft(e){const t=e.trim().match(gt);return t?{value:parseFloat(t[1]),unit:t[2]}:null}function yt(e,t){return`${e}${t}`}function bt(e){return gt.test(e.trim())}function xt(e){const t={weekdays:e.weekdays,time:e.time,target_channels:e.target_channels,level:e.level};return"fixed_time"!==e.condition&&(t.condition=e.condition),null!==e.astro_type&&(t.astro_type=e.astro_type),0!==e.astro_offset_minutes&&(t.astro_offset_minutes=e.astro_offset_minutes),null!==e.level_2&&(t.level_2=e.level_2),null!==e.duration&&(t.duration=e.duration),null!==e.ramp_time&&(t.ramp_time=e.ramp_time),t}function $t(e){const t={};for(const[i,s]of Object.entries(e))t[i]=xt(s);return t}function kt(e,t=5,i=30.5){const{base_temperature:s,periods:a}=e;if(s<t||s>i)return{key:"temperatureOutOfRange",params:{block:"base",min:`${t}`,max:`${i}`}};let n=0;for(let e=0;e<a.length;e++){const s=a[e];if(!s.starttime||!s.endtime||void 0===s.temperature)return{key:"slotMissingValues",params:{slot:`${e+1}`}};const r=rt(s.starttime),o=rt(s.endtime);if(o<=r)return{key:"blockEndBeforeStart",params:{block:`${e+1}`}};if(r<n)return{key:"slotTimeBackwards",params:{slot:`${e+1}`,time:s.starttime}};if(s.temperature<t||s.temperature>i)return{key:"temperatureOutOfRange",params:{block:`${e+1}`,min:`${t}`,max:`${i}`}};n=o}return null}const wt=r`
  :host {
    display: block;
  }
...
`;var St=function(e,t,i,s){var a,n=arguments.length,r=n<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(e,t,i,s);else for(var o=e.length-1;o>=0;o--)(a=e[o])&&(r=(n<3?a(r):n>3?a(t,i,r):a(t,i))||r);return n>3&&r&&Object.defineProperty(t,i,r),r};let Et=class extends oe{constructor(){super(...arguments),this.editable=!1,this.showTemperature=!0,this.showGradient=!1,this.temperatureUnit="°C",this.hourFormat="24",this.editorOpen=!1,this._currentTimePercent=0,this._currentTimeMinutes=0}connectedCallback(){super.connectedCallback(),this._updateCurrentTime(),this._timeUpdateInterval=window.setInterval(()=>{this._updateCurrentTime()},6e4)}disconnectedCallback(){super.disconnectedCallback(),void 0!==this._timeUpdateInterval&&(clearInterval(this._timeUpdateInterval),this._timeUpdateInterval=void 0)}willUpdate(e){super.willUpdate(e)}_updateCurrentTime(){const e=new Date,t=60*e.getHours()+e.getMinutes();this._currentTimePercent=t/1440*100,this._currentTimeMinutes=t;const i=e.getDay();this._currentWeekday=["SUNDAY","MONDAY","TUESDAY","WEDNESDAY","THURSDAY","FRIDAY","SATURDAY"][i]}_isBlockActive(e,t){return!(!this._currentWeekday||this._currentWeekday!==e)&&this._currentTimeMinutes>=t.startMinutes&&this._currentTimeMinutes<t.endMinutes}_getTimeLabels(){const e=[];for(let t=0;t<=24;t+=3){const i=`${t.toString().padStart(2,"0")}:00`;e.push({hour:t,label:dt(i,this.hourFormat),position:t/24*100})}return e}_formatTimeDisplay(e){return dt(e,this.hourFormat)}_getBaseTemperature(e){if(this.scheduleData){const t=this.scheduleData[e];if(t){const{baseTemperature:e}=ct(t);return e}}return 20}_getParsedBlocks(e){if(this.scheduleData){const t=this.scheduleData[e];if(!t)return[];const{blocks:i}=ct(t);return i}return[]}_getWeekdayLabel(e){return this.translations?.weekdayShortLabels[e]??e.slice(0,2)}_handleWeekdayClick(e){this.editable&&this.dispatchEvent(new CustomEvent("weekday-click",{detail:{weekday:e},bubbles:!0,composed:!0}))}_handleCopy(e,t){t.stopPropagation(),this.dispatchEvent(new CustomEvent("copy-schedule",{detail:{weekday:e},bubbles:!0,composed:!0}))}_handlePaste(e,t){t.stopPropagation(),this.dispatchEvent(new CustomEvent("paste-schedule",{detail:{weekday:e},bubbles:!0,composed:!0}))}render(){return this.scheduleData?W`
      <div class="schedule-container">
        ...
        <div class="time-axis-labels">
          ${tt(this._getTimeLabels(),e=>e.hour,e=>W`
        ...
        <div class="schedule-content">
          ${tt(it,e=>`${e}-${this.currentProfile}-${this.scheduleDataHash}`,e=>{const t=this._getParsedBlocks(e),i=this._getBaseTemperature(e),s=_t(t,i);return W`
                <div
                  class="time-blocks ${this.editable?"editable":""}"
                  @click=${()=>this._handleWeekdayClick(e)}
                >
                  ${tt(s,e=>`${e.slot}-${e.startMinutes}-${this.currentProfile}`,(a,n)=>{const r=this._isBlockActive(e,a),o=a.temperature===i&&!t.some(e=>e.startMinutes===a.startMinutes&&e.endMinutes===a.endMinutes);let d;if(o)d="background-color: var(--secondary-background-color, #e0e0e0);";else if(this.showGradient){d=`background: ${function(e,t,i){const s=lt(e);return null===t&&null===i?s:null!==t&&null===i?`linear-gradient(to bottom, ${lt(t)}, ${s})`:null===t&&null!==i?`linear-gradient(to bottom, ${s}, ${lt(i)})`:`linear-gradient(to bottom, ${lt(t)}, ${s} 50%, ${lt(i)})`}(a.temperature,n>0?s[n-1].temperature:null,n<s.length-1?s[n+1].temperature:null)};`}else d=`background-color: ${lt(a.temperature)};`;return W`
                        <div
    ...
    `:W``}static{this.styles=wt}};St([he({attribute:!1})],Et.prototype,"scheduleData",void 0),St([he({type:Boolean})],Et.prototype,"editable",void 0),St([he({type:Boolean})],Et.prototype,"showTemperature",void 0),St([he({type:Boolean})],Et.prototype,"showGradient",void 0),St([he({type:String})],Et.prototype,"temperatureUnit",void 0),St([he({type:String})],Et.prototype,"hourFormat",void 0),St([he({attribute:!1})],Et.prototype,"translations",void 0),St([he({type:String})],Et.prototype,"copiedWeekday",void 0),St([he({type:Boolean})],Et.prototype,"editorOpen",void 0),St([he({type:String})],Et.prototype,"currentProfile",void 0),St([he({type:String})],Et.prototype,"scheduleDataHash",void 0),St([pe()],Et.prototype,"_currentTimePercent",void 0),St([pe()],Et.prototype,"_currentTimeMinutes",void 0),St([pe()],Et.prototype,"_currentWeekday",void 0),Et=St([je("hmip-schedule-grid")],Et);const Ct=r`
  :host {
    display: block;
  }
...
`;var At=function(e,t,i,s){var a,n=arguments.length,r=n<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(e,t,i,s);else for(var o=e.length-1;o>=0;o--)(a=e[o])&&(r=(n<3?a(r):n>3?a(t,i,r):a(t,i))||r);return n>3&&r&&Object.defineProperty(t,i,r),r};let Dt=class extends oe{constructor(){super(),this.open=!1,this.minTemp=5,this.maxTemp=30.5,this.tempStep=.5,this.temperatureUnit="°C",this.hourFormat="24",this._validationWarnings=[],this._historyStack=[],this._historyIndex=-1,this._keyDownHandler=this._handleKeyDown.bind(this)}connectedCallback(){super.connectedCallback(),window.addEventListener("keydown",this._keyDownHandler)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("keydown",this._keyDownHandler)}willUpdate(e){if(super.willUpdate(e),(e.has("open")||e.has("weekday"))&&this.open&&this.weekday){const t=e.get("open"),i=e.get("weekday");(!t&&this.open||this.open&&i!==this.weekday)&&this._initializeEditor(this.weekday)}}_initializeEditor(e){this._editingWeekday=e,this._editingBlocks=this._getParsedBlocks(e),this._editingSlotIndex=void 0,this._editingSlotData=void 0;const t=this.scheduleData?.[e];if(t){const{baseTemperature:e}=ct(t);this._editingBaseTemperature=e}else this._editingBaseTemperature=20;this._historyStack=[JSON.parse(JSON.stringify(this._editingBlocks))],this._historyIndex=0,this._updateValidationWarnings()}_getParsedBlocks(e){if(this.scheduleData){const t=this.scheduleData[e];if(!t)return[];const{blocks:i}=ct(t);return i}return[]}_getWeekdayLabel(e,t){return"long"===t?this.translations?.weekdayLongLabels[e]??e:this.translations?.weekdayShortLabels[e]??e.slice(0,2)}_formatTimeDisplay(e){return dt(e,this.hourFormat)}_formatValidationParams(e){if(!e)return{};const t={};for(const[i,s]of Object.entries(e))"weekday"===i&&it.includes(s)?t.weekday=this._getWeekdayLabel(s,"long"):t[i]=s;return t}_translateValidationMessage(e){const t=this.translations?.validationMessages[e.key]||e.key,i=this._formatValidationParams(e.params);e.nested&&(i.details=this._translateValidationMessage(e.nested));let s=t;for(const[e,t]of Object.entries(i))s=s.replace(`{${e}}`,t);return s}_saveHistoryState(){if(!this._editingBlocks)return;const e=JSON.parse(JSON.stringify(this._editingBlocks));this._historyStack=this._historyStack.slice(0,this._historyIndex+1),this._historyStack.push(e),this._historyIndex++,this._historyStack.length>50&&(this._historyStack.shift(),this._historyIndex--)}_undo(){this._historyIndex<=0||(this._historyIndex--,this._editingBlocks=JSON.parse(JSON.stringify(this._historyStack[this._historyIndex])),this._updateValidationWarnings())}_redo(){this._historyIndex>=this._historyStack.length-1||(this._historyIndex++,this._editingBlocks=JSON.parse(JSON.stringify(this._historyStack[this._historyIndex])),this._updateValidationWarnings())}_canUndo(){return this._historyIndex>0}_canRedo(){return this._historyIndex<this._historyStack.length-1}_handleKeyDown(e){if(!this.open||!this._editingWeekday||!this._editingBlocks)return;const t=e.ctrlKey||e.metaKey;t&&"z"===e.key&&!e.shiftKey?(e.preventDefault(),this._undo()):t&&("y"===e.key||"z"===e.key&&e.shiftKey)&&(e.preventDefault(),this._redo())}_updateValidationWarnings(){this._validationWarnings=this._editingBlocks?function(e,t=5,i=30.5){const s=[];if(0===e.length)return s;for(let t=0;t<e.length-1;t++){const i=e[t];i.endMinutes<i.startMinutes&&s.push({key:"blockEndBeforeStart",params:{block:`${t+1}`}}),i.endMinutes===i.startMinutes&&s.push({key:"blockZeroDuration",params:{block:`${t+1}`}})}const a=e[e.length-1];return a.endMinutes<a.startMinutes&&s.push({key:"blockEndBeforeStart",params:{block:`${e.length}`}}),e.forEach((e,a)=>{(e.startMinutes<0||e.startMinutes>1440)&&s.push({key:"invalidStartTime",params:{block:`${a+1}`}}),(e.endMinutes<0||e.endMinutes>1440)&&s.push({key:"invalidEndTime",params:{block:`${a+1}`}}),(e.temperature<t||e.temperature>i)&&s.push({key:"temperatureOutOfRange",params:{block:`${a+1}`,min:`${t}`,max:`${i}`}})}),s}(this._editingBlocks,this.minTemp,this.maxTemp):[]}_startSlotEdit(e){if(!this._editingBlocks||e<0||e>=this._editingBlocks.length)return;const t=this._editingBlocks[e];this._editingSlotIndex=e,this._editingSlotData={startTime:t.startTime,endTime:t.endTime,temperature:t.temperature}}_startSlotEditFromDisplay(e,t){if(!this._editingBlocks)return;const i=t[e],s=this._editingBlocks.findIndex(e=>e.startMinutes===i.startMinutes&&e.endMinutes===i.endMinutes&&e.temperature===i.temperature);-1!==s&&this._startSlotEdit(s)}_cancelSlotEdit(){this._editingSlotIndex=void 0,this._editingSlotData=void 0}_saveSlotEdit(){if(void 0===this._editingSlotIndex||!this._editingSlotData||!this._editingBlocks||void 0===this._editingBaseTemperature)return;const e=this._editingSlotIndex,{startTime:t,endTime:i,temperature:s}=this._editingSlotData,a={startTime:t,startMinutes:rt(t),endTime:i,endMinutes:rt(i),temperature:s,slot:e+1},n=this._editingBlocks.filter((t,i)=>i!==e),r=function(e,t){const i=[],s=t.startMinutes,a=t.endMinutes,n=[...e].sort((e,t)=>e.startMinutes-t.startMinutes);for(const e of n){const t=e.startMinutes,n=e.endMinutes;n<=s||t>=a?i.push(e):(t<s&&i.push({...e,endTime:ot(s),endMinutes:s,slot:i.length+1}),n>a&&i.push({...e,startTime:ot(a),startMinutes:a,slot:i.length+1}))}i.push({...t,slot:i.length+1});const r=i.sort((e,t)=>e.startMinutes-t.startMinutes);return pt(r)}(n,a),o=pt(ut(r));this._saveHistoryState(),this._editingBlocks=o,this._editingSlotIndex=void 0,this._editingSlotData=void 0,this._updateValidationWarnings()}_addNewSlot(){if(!this._editingBlocks||void 0===this._editingBaseTemperature)return;if(this._editingBlocks.length>=12)return;let e=0,t=60;if(this._editingBlocks.length>0){const i=ut(this._editingBlocks),s=i[i.length-1];if(s.endMinutes<1440)e=s.endMinutes,t=Math.min(e+60,1440);else{let s=!1;for(let a=0;a<i.length;a++){const n=0===a?0:i[a-1].endMinutes;if(i[a].startMinutes>n){e=n,t=i[a].startMinutes,s=!0;break}}if(!s)return}}const i=Math.min(this._editingBaseTemperature+2,this.maxTemp),s={startTime:ot(e),startMinutes:e,endTime:ot(t),endMinutes:t,temperature:i,slot:this._editingBlocks.length+1};this._saveHistoryState();const a=ut([...this._editingBlocks,s]);this._editingBlocks=a;const n=a.findIndex(i=>i.startMinutes===e&&i.endMinutes===t);n>=0&&this._startSlotEdit(n),this._updateValidationWarnings()}_removeTimeBlockByIndex(e,t){if(!this._editingBlocks||void 0===this._editingBaseTemperature)return;const i=t[e],s=this._editingBlocks.findIndex(e=>e.startMinutes===i.startMinutes&&e.endMinutes===i.endMinutes&&e.temperature===i.temperature);if(-1===s)return;this._saveHistoryState();const a=this._editingBlocks.filter((e,t)=>t!==s);this._editingBlocks=pt(ut(a)),this._updateValidationWarnings()}_switchToWeekday(e){e!==this._editingWeekday&&this._initializeEditor(e)}_closeEditor(){this._editingWeekday=void 0,this._editingBlocks=void 0,this._editingBaseTemperature=void 0,this._editingSlotIndex=void 0,this._editingSlotData=void 0,this._historyStack=[],this._historyIndex=-1,this.dispatchEvent(new CustomEvent("editor-closed",{bubbles:!0,composed:!0}))}_saveSchedule(){if(!this._editingWeekday||!this._editingBlocks||void 0===this._editingBaseTemperature)return;const e=kt(ht(this._editingBlocks,this._editingBaseTemperature),this.minTemp,this.maxTemp);if(e){const t=this._translateValidationMessage(e);return void this.dispatchEvent(new CustomEvent("validation-failed",{detail:{error:t},bubbles:!0,composed:!0}))}this.dispatchEvent(new CustomEvent("save-schedule",{detail:{weekday:this._editingWeekday,blocks:this._editingBlocks,baseTemperature:this._editingBaseTemperature},bubbles:!0,composed:!0}))}_saveAndClose(){this._saveSchedule()}render(){return this.open&&this._editingWeekday?W`
    ...
    `:W``}_formatEdit(e){return(this.translations?.edit??"Edit {weekday}").replace("{weekday}",this._getWeekdayLabel(e,"long"))}_renderEditor(){if(!this._editingWeekday||!this._editingBlocks)return W``;const e=void 0!==this._editingBaseTemperature?_t(this._editingBlocks,this._editingBaseTemperature):this._editingBlocks;return W`
      <div class="editor">
    ...
    `}static{this.styles=Ct}};At([he({type:Boolean})],Dt.prototype,"open",void 0),At([he({type:String})],Dt.prototype,"weekday",void 0),At([he({attribute:!1})],Dt.prototype,"scheduleData",void 0),At([he({type:Number})],Dt.prototype,"minTemp",void 0),At([he({type:Number})],Dt.prototype,"maxTemp",void 0),At([he({type:Number})],Dt.prototype,"tempStep",void 0),At([he({type:String})],Dt.prototype,"temperatureUnit",void 0),At([he({type:String})],Dt.prototype,"hourFormat",void 0),At([he({attribute:!1})],Dt.prototype,"translations",void 0),At([pe()],Dt.prototype,"_editingWeekday",void 0),At([pe()],Dt.prototype,"_editingBlocks",void 0),At([pe()],Dt.prototype,"_editingBaseTemperature",void 0),At([pe()],Dt.prototype,"_validationWarnings",void 0),At([pe()],Dt.prototype,"_editingSlotIndex",void 0),At([pe()],Dt.prototype,"_editingSlotData",void 0),Dt=At([je("hmip-schedule-editor")],Dt);const Tt=r`
  :host {
    display: block;
  }
...
`;var It=function(e,t,i,s){var a,n=arguments.length,r=n<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(e,t,i,s);else for(var o=e.length-1;o>=0;o--)(a=e[o])&&(r=(n<3?a(r):n>3?a(t,i,r):a(t,i))||r);return n>3&&r&&Object.defineProperty(t,i,r),r};let Mt=class extends oe{constructor(){super(...arguments),this.editable=!0}static{this.styles=Tt}_handleAdd(){this.dispatchEvent(new CustomEvent("add-event",{bubbles:!0,composed:!0}))}_handleEdit(e){this.dispatchEvent(new CustomEvent("edit-event",{bubbles:!0,composed:!0,detail:{entry:e}}))}_handleDelete(e){this.dispatchEvent(new CustomEvent("delete-event",{bubbles:!0,composed:!0,detail:{entry:e}}))}render(){if(!this.scheduleData)return W`<div class="no-data">${this.translations.loading}</div>`;const e=function(e){const t=[];for(const[i,s]of Object.entries(e))t.push({...s,groupNo:i,isActive:vt(s)});return t.sort((e,t)=>e.time.localeCompare(t.time)),t}(this.scheduleData);return 0===e.length?W`
        <div class="no-data">
    ...
    `}_renderEvent(e){const t=function(e,t){const i=t?at[t]:void 0;return"binary"===i?.levelType?0===e?"Off":"On":`${Math.round(100*e)}%`}(e.level,this.domain),i=function(e){if(!e)return"-";const t=ft(e);return t?`${t.value}${{ms:"ms",s:"s",min:"min",h:"h"}[t.unit]}`:e}(e.duration);return W`
      <div
      ...
      >
        ...
        <div class="col-weekdays">
          <div class="weekday-badges">
            ${it.map(t=>{const i=e.weekdays.includes(t);return W`<span class="weekday-badge ${i?"active":"inactive"}"
    ...
    `}};It([he({attribute:!1})],Mt.prototype,"scheduleData",void 0),It([he({attribute:!1})],Mt.prototype,"domain",void 0),It([he({type:Boolean})],Mt.prototype,"editable",void 0),It([he({attribute:!1})],Mt.prototype,"translations",void 0),Mt=It([je("hmip-device-schedule-list")],Mt);const Pt=r`
  :host {
    display: block;
  }
...
`;var Lt=function(e,t,i,s){var a,n=arguments.length,r=n<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(e,t,i,s);else for(var o=e.length-1;o>=0;o--)(a=e[o])&&(r=(n<3?a(r):n>3?a(t,i,r):a(t,i))||r);return n>3&&r&&Object.defineProperty(t,i,r),r};let zt=class extends oe{constructor(){super(...arguments),this.open=!1,this.isNewEvent=!1,this._validationErrors=[]}static{this.styles=Pt}willUpdate(e){(e.has("open")||e.has("entry"))&&(this.open&&this.entry?(this._editingEntry={...this.entry},this._validationErrors=[]):this.open||(this._editingEntry=void 0,this._validationErrors=[]))}_updateEditingEntry(e){this._editingEntry&&(this._editingEntry={...this._editingEntry,...e},this._validationErrors=[],this.requestUpdate())}_handleClose(){this.dispatchEvent(new CustomEvent("editor-closed",{bubbles:!0,composed:!0}))}_handleSave(){if(!this._editingEntry||void 0===this.groupNo)return;const e=function(e,t){const i=[];(function(e){try{return function(e){const t=e.split(":");if(2!==t.length)throw new Error(`Invalid time format: ${e}`);const i=parseInt(t[0],10),s=parseInt(t[1],10);if(isNaN(i)||isNaN(s)||i<0||i>23||s<0||s>59)throw new Error(`Invalid time values: ${e}`)}(e),!0}catch{return!1}})(e.time)||i.push({field:"time",message:"Time must be in HH:MM format (00:00-23:59)"}),e.weekdays&&0!==e.weekdays.length||i.push({field:"weekdays",message:"At least one weekday must be selected"}),e.target_channels&&0!==e.target_channels.length||i.push({field:"target_channels",message:"At least one target channel must be selected"});const s=t?at[t]:void 0;return"binary"===s?.levelType?0!==e.level&&1!==e.level&&i.push({field:"level",message:"Level must be 0 or 1 for switch"}):(e.level<0||e.level>1)&&i.push({field:"level",message:"Level must be between 0.0 and 1.0"}),"cover"===t&&null!==e.level_2&&(e.level_2<0||e.level_2>1)&&i.push({field:"level_2",message:"Slat position must be between 0.0 and 1.0"}),mt(e.condition)&&(e.astro_offset_minutes<-720||e.astro_offset_minutes>720)&&i.push({field:"astro_offset_minutes",message:"Astro offset must be between -720 and 720 minutes"}),null===e.duration||bt(e.duration)||i.push({field:"duration",message:"Invalid duration format"}),null===e.ramp_time||bt(e.ramp_time)||i.push({field:"ramp_time",message:"Invalid ramp time format"}),i}(this._editingEntry,this.domain);e.length>0?this._validationErrors=e.map(e=>`${e.field}: ${e.message}`):this.dispatchEvent(new CustomEvent("save-event",{bubbles:!0,composed:!0,detail:{entry:{...this._editingEntry},groupNo:this.groupNo}}))}render(){return this.open&&this._editingEntry?W`
    ...
    `:W``}_renderConditionFields(){if(!this._editingEntry)return W``;const e=mt(this._editingEntry.condition);return W`
      <div class="form-group">
    ...
    `}_renderWeekdayFields(){return this._editingEntry?W`
      <div class="form-group">
        ...
        <div class="weekday-checkboxes">
          ${it.map(e=>{const t=this._editingEntry.weekdays.includes(e);return W`
    ...
    `:W``}_renderLevelFields(){if(!this._editingEntry)return W``;const e=this.domain?at[this.domain]:void 0;return W`
      <div class="form-group">
      ...
      ${e?.hasLevel2?W`
          ...
          `:""}
    `}_renderDurationFields(){if(!this._editingEntry)return W``;const e=this.domain?at[this.domain]:void 0;if(e&&!e.hasDuration)return W``;const t=this._editingEntry.duration?ft(this._editingEntry.duration):null,i=t?.value??0,s=t?.unit??"s";return W`
      <div class="form-group">
        ...
        <div class="duration-row">
          ...
          <ha-select
            .value=${s}
            @selected=${e=>{i>0&&this._updateEditingEntry({duration:yt(i,e.target.value)})}}
          >
            ${nt.map(e=>W`
    ...
    `}_renderRampTimeFields(){if(!this._editingEntry)return W``;const e=this.domain?at[this.domain]:void 0;if(e&&!e.hasRampTime)return W``;const t=this._editingEntry.ramp_time?ft(this._editingEntry.ramp_time):null,i=t?.value??0,s=t?.unit??"s";return W`
      <div class="form-group">
        ...
        <div class="duration-row">
          ...
          <ha-select
            .value=${s}
            @selected=${e=>{i>0&&this._updateEditingEntry({ramp_time:yt(i,e.target.value)})}}
          >
            ${nt.map(e=>W`
                <ha-list-item .value=${e} ?selected=${e===s}>${e}</ha-list-item>
              `)}
    ...
    `:W``}};Lt([he({type:Boolean})],zt.prototype,"open",void 0),Lt([he({attribute:!1})],zt.prototype,"entry",void 0),Lt([he()],zt.prototype,"groupNo",void 0),Lt([he({type:Boolean})],zt.prototype,"isNewEvent",void 0),Lt([he({attribute:!1})],zt.prototype,"domain",void 0),Lt([he({attribute:!1})],zt.prototype,"availableTargetChannels",void 0),Lt([he({attribute:!1})],zt.prototype,"translations",void 0),Lt([pe()],zt.prototype,"_editingEntry",void 0),Lt([pe()],zt.prototype,"_validationErrors",void 0),zt=Lt([je("hmip-device-schedule-editor")],zt);let Nt=class extends oe{constructor(){super(...arguments),this.entryId="",this.deviceAddress="",this.deviceName="",this._devices=[],this._selectedDevice=null,this._climateData=null,this._deviceData=null,this._selectedProfile="",this._loading=!0,this._saving=!1,this._error="",this._deviceShowEditor=!1,this._deviceIsNewEvent=!1}updated(e){(e.has("entryId")||e.has("deviceAddress"))&&this.entryId&&this._fetchDevices()}async _fetchDevices(){this._loading=!0,this._error="";try{if(this._devices=await $e(this.hass,this.entryId),this.deviceAddress){const e=this._devices.find(e=>e.address===this.deviceAddress);e&&(this._selectedDevice=e,await this._loadSchedule(e))}}catch(e){this._error=String(e)}finally{this._loading=!1}}async _loadSchedule(e){this._loading=!0,this._error="",this._climateData=null,this._deviceData=null;try{if("climate"===e.schedule_type){const t=await async function(e,t,i,s){return e.callWS({type:"homematicip_local/config/get_climate_schedule",entry_id:t,device_address:i,...s&&{profile:s}})}(this.hass,this.entryId,e.address,this._selectedProfile||void 0);this._climateData=t,this._selectedProfile||(this._selectedProfile=t.active_profile)}else this._deviceData=await async function(e,t,i){return e.callWS({type:"homematicip_local/config/get_device_schedule",entry_id:t,device_address:i})}(this.hass,this.entryId,e.address)}catch{this._error=this._l("device_schedule.load_failed")}finally{this._loading=!1}}_l(e,t){return Te(this.hass,e,t)}_handleBack(){this.dispatchEvent(new CustomEvent("back",{bubbles:!0,composed:!0}))}async _handleDeviceSelect(e){const t=e.target.value;if(!t)return void(this._selectedDevice=null);const i=this._devices.find(e=>e.address===t);i&&(this._selectedDevice=i,this._selectedProfile="",this._editingWeekday=void 0,this._copiedSchedule=void 0,this._deviceShowEditor=!1,this._deviceEditingEntry=void 0,this._deviceEditingGroupNo=void 0,this._deviceIsNewEvent=!1,await this._loadSchedule(i))}async _handleProfileChange(e){this._selectedProfile=e.target.value,this._selectedDevice&&await this._loadSchedule(this._selectedDevice)}async _handleSetActiveProfile(){if(this._selectedDevice&&this._selectedProfile)try{await async function(e,t,i,s){return e.callWS({type:"homematicip_local/config/set_climate_active_profile",entry_id:t,device_address:i,profile:s})}(this.hass,this.entryId,this._selectedDevice.address,this._selectedProfile),this._climateData&&(this._climateData={...this._climateData,active_profile:this._selectedProfile}),Le(this,{message:this._l("device_schedule.save_success")})}catch{Le(this,{message:this._l("device_schedule.save_failed")})}}_onWeekdayClick(e){this._editingWeekday=e.detail.weekday}_onCopySchedule(e){const t=e.detail.weekday;if(!this._climateData)return;const i=this._climateData.schedule_data[t];if(!i)return;const{blocks:s,baseTemperature:a}=ct(i);this._copiedSchedule={weekday:t,blocks:JSON.parse(JSON.stringify(s)),baseTemperature:a}}async _onPasteSchedule(e){const t=e.detail.weekday;if(!this._selectedDevice||!this._copiedSchedule||!this._climateData)return;const i=this._copiedSchedule.baseTemperature??function(e){if(0===e.length)return 20;const t=new Map;for(const i of e){const e=i.endMinutes-i.startMinutes,s=t.get(i.temperature)||0;t.set(i.temperature,s+e)}let i=0,s=20;for(const[e,a]of t.entries())a>i&&(i=a,s=e);return s}(this._copiedSchedule.blocks),s=ht(this._copiedSchedule.blocks,i);if(kt(s,this._climateData.min_temp??5,this._climateData.max_temp??30.5))Le(this,{message:this._l("device_schedule.invalid_schedule")});else{this._saving=!0;try{const{base_temperature:e,periods:i}=s;await ke(this.hass,this.entryId,this._selectedDevice.address,this._selectedProfile,t,e,i.map(e=>({...e}))),Le(this,{message:this._l("device_schedule.save_success")}),await this._loadSchedule(this._selectedDevice)}catch{Le(this,{message:this._l("device_schedule.save_failed")})}finally{this._saving=!1}}}async _onSaveSchedule(e){if(!this._selectedDevice||!this._climateData)return;const{weekday:t,blocks:i,baseTemperature:s}=e.detail,a=ht(i,s);if(kt(a,this._climateData.min_temp??5,this._climateData.max_temp??30.5))Le(this,{message:this._l("device_schedule.invalid_schedule")});else{this._saving=!0;try{const{base_temperature:e,periods:i}=a;await ke(this.hass,this.entryId,this._selectedDevice.address,this._selectedProfile,t,e,i.map(e=>({...e}))),Le(this,{message:this._l("device_schedule.save_success")}),this._editingWeekday=void 0,await this._loadSchedule(this._selectedDevice)}catch{Le(this,{message:this._l("device_schedule.save_failed")})}finally{this._saving=!1}}}_onValidationFailed(e){Le(this,{message:this._l("device_schedule.invalid_schedule",{error:e.detail.error})})}_onEditorClosed(){this._editingWeekday=void 0}async _handleReload(){if(this._selectedDevice)try{await async function(e,t,i){return e.callWS({type:"homematicip_local/config/reload_device_config",entry_id:t,device_address:i})}(this.hass,this.entryId,this._selectedDevice.address),Le(this,{message:this._l("device_schedule.reload_success")}),await this._loadSchedule(this._selectedDevice)}catch{Le(this,{message:this._l("device_schedule.reload_failed")})}}async _handleExport(){const e=this._climateData?.schedule_data??this._deviceData?.schedule_data;if(!e)return;const t=JSON.stringify(e,null,2),i=new Blob([t],{type:"application/json"}),s=URL.createObjectURL(i),a=document.createElement("a");a.href=s;const n=this._selectedDevice?.address.replace(/:/g,"_")??"schedule";a.download=`${n}_schedule.json`,a.click(),URL.revokeObjectURL(s)}async _handleImport(){const e=document.createElement("input");e.type="file",e.accept=".json",e.onchange=async()=>{const t=e.files?.[0];if(t&&this._selectedDevice)try{const e=await t.text(),i=JSON.parse(e);if(!await Me(0,{title:this._l("device_schedule.import_confirm_title"),text:this._l("device_schedule.import_confirm_text"),confirmText:this._l("device_schedule.import"),dismissText:this._l("common.cancel")}))return;"climate"===this._selectedDevice.schedule_type?(this._climateData={...this._climateData,schedule_data:i},Le(this,{message:this._l("device_schedule.import_success")})):(await we(this.hass,this.entryId,this._selectedDevice.address,i),Le(this,{message:this._l("device_schedule.import_success")}),await this._loadSchedule(this._selectedDevice))}catch{Le(this,{message:this._l("device_schedule.import_failed")})}},e.click()}_buildGridTranslations(){return{weekdayShortLabels:{MONDAY:this._l("device_schedule.weekdays").split(",")[0],TUESDAY:this._l("device_schedule.weekdays").split(",")[1],WEDNESDAY:this._l("device_schedule.weekdays").split(",")[2],THURSDAY:this._l("device_schedule.weekdays").split(",")[3],FRIDAY:this._l("device_schedule.weekdays").split(",")[4],SATURDAY:this._l("device_schedule.weekdays").split(",")[5],SUNDAY:this._l("device_schedule.weekdays").split(",")[6]},clickToEdit:this._l("device_schedule.click_to_edit"),copySchedule:this._l("device_schedule.copy_schedule"),pasteSchedule:this._l("device_schedule.paste_schedule")}}_buildEditorTranslations(){const e=this._l("device_schedule.weekdays").split(",");return{weekdayShortLabels:{MONDAY:e[0],TUESDAY:e[1],WEDNESDAY:e[2],THURSDAY:e[3],FRIDAY:e[4],SATURDAY:e[5],SUNDAY:e[6]},weekdayLongLabels:{MONDAY:this._l("device_schedule.weekday_monday"),TUESDAY:this._l("device_schedule.weekday_tuesday"),WEDNESDAY:this._l("device_schedule.weekday_wednesday"),THURSDAY:this._l("device_schedule.weekday_thursday"),FRIDAY:this._l("device_schedule.weekday_friday"),SATURDAY:this._l("device_schedule.weekday_saturday"),SUNDAY:this._l("device_schedule.weekday_sunday")},edit:this._l("device_schedule.edit"),cancel:this._l("common.cancel"),save:this._l("device_schedule.save"),addTimeBlock:this._l("device_schedule.add_time_block"),from:this._l("device_schedule.from"),to:this._l("device_schedule.to"),baseTemperature:this._l("device_schedule.base_temperature"),baseTemperatureDescription:this._l("device_schedule.base_temperature_description"),temperaturePeriods:this._l("device_schedule.temperature_periods"),editSlot:this._l("device_schedule.edit_slot"),saveSlot:this._l("device_schedule.save_slot"),cancelSlotEdit:this._l("device_schedule.cancel_slot_edit"),undoShortcut:this._l("device_schedule.undo_shortcut"),redoShortcut:this._l("device_schedule.redo_shortcut"),warningsTitle:this._l("device_schedule.warnings_title"),validationMessages:{blockEndBeforeStart:this._l("device_schedule.validation_block_end_before_start"),blockZeroDuration:this._l("device_schedule.validation_block_zero_duration"),invalidStartTime:this._l("device_schedule.validation_invalid_start_time"),invalidEndTime:this._l("device_schedule.validation_invalid_end_time"),temperatureOutOfRange:this._l("device_schedule.validation_temp_out_of_range"),invalidSlotCount:this._l("device_schedule.validation_invalid_slot_count"),invalidSlotKey:this._l("device_schedule.validation_invalid_slot_key"),missingSlot:this._l("device_schedule.validation_missing_slot"),slotMissingValues:this._l("device_schedule.validation_slot_missing_values"),slotTimeBackwards:this._l("device_schedule.validation_slot_time_backwards"),slotTimeExceedsDay:this._l("device_schedule.validation_slot_time_exceeds_day"),lastSlotMustEnd:this._l("device_schedule.validation_last_slot_must_end"),scheduleMustBeObject:this._l("device_schedule.validation_schedule_must_be_object"),missingWeekday:this._l("device_schedule.validation_missing_weekday"),invalidWeekdayData:this._l("device_schedule.validation_invalid_weekday_data"),weekdayValidationError:this._l("device_schedule.validation_weekday_error")}}}render(){return this._loading&&0===this._devices.length?W`<div class="loading">${this._l("common.loading")}</div>`:this._error&&0===this._devices.length?W`<div class="error">${this._error}</div>`:W`
      <ha-icon-button
        class="back-button"
        .path=${"M20,11V13H8L13.5,18.5L12.08,19.92L4.16,12L12.08,4.08L13.5,5.5L8,11H20Z"}
        @click=${this._handleBack}
